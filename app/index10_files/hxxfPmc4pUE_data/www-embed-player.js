...
;var Ma=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};q("yt.config_",Ma,void 0);var Na=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};q("yt.msgs_",Na,void 0);function Oa(a,b){return a in Ma?Ma[a]:b}
function x(a,b){ga(a)&&(a=Pa(a));return window.setTimeout(a,b)}
function Qa(a){window.clearTimeout(a)}
function Pa(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){Ra(b)}}:a}
function Ra(a,b){var c=t("yt.logging.errors.log");c?c(a,b,void 0,void 0,void 0):(c=Oa("ERRORS",[]),c.push([a,b,void 0,void 0,void 0]),Sa("ERRORS",c))}
...
function Sa(a){Ta(Ma,arguments)}
;function Wa(a,b,c){a&&(a.dataset?a.dataset[Xa(b)]=c:a.setAttribute("data-"+b,c))}
function Ya(a,b){return a?a.dataset?a.dataset[Xa(b)]:a.getAttribute("data-"+b):null}
function Za(a,b){a&&(a.dataset?delete a.dataset[Xa(b)]:a.removeAttribute("data-"+b))}
var $a={};function Xa(a){return $a[a]||($a[a]=String(a).replace(/\-([a-z])/g,function(a,c){return c.toUpperCase()}))}
...
function ab(a,b){a.S?p(void 0)?b.call(void 0):b():(a.H||(a.H=[]),a.H.push(p(void 0)?v(b,void 0):b))}
y.prototype.G=function(){if(this.H)for(;this.H.length;)this.H.shift()()};
function bb(a){a&&"function"==typeof a.dispose&&a.dispose()}
function cb(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];ea(d)?cb.apply(null,d):bb(d)}}
;var db;a:{var eb=n.navigator;if(eb){var fb=eb.userAgent;if(fb){db=fb;break a}}db=""}function z(a){return-1!=db.indexOf(a)}
;function gb(a){Ta(Ma,arguments)}
...
vb.prototype.reset=function(){this.next=this.scope=this.b=null};function xb(a,b){isNaN(b)&&(b=void 0);var c=t("yt.scheduler.instance.addJob");return c?c(a,1,b):void 0===b?(a(),NaN):x(a,b||0)}
;function yb(){this.b="";this.f=zb}
yb.prototype.za=!0;yb.prototype.ya=function(){return this.b};
var zb={};function Ab(){return z("Safari")&&!(Bb()||z("Coast")||z("Opera")||z("Edge")||z("Silk")||z("Android"))}
function Bb(){return(z("Chrome")||z("CriOS"))&&!z("Edge")}
...
Fb.prototype.za=!0;Fb.prototype.ya=function(){return this.b};
function Hb(a){if(a instanceof Fb&&a.constructor===Fb&&a.f===Gb)return a.b;ca(a);return"type_error:SafeUrl"}
var Ib=/^(?:(?:https?|mailto|ftp):|[^&:/?#]*(?:[/?#]|$))/i;function Jb(a){if(a instanceof Fb)return a;a=a.za?a.ya():String(a);Ib.test(a)||(a="about:invalid#zClosurez");return Kb(a)}
var Gb={};function Kb(a){var b=new Fb;b.b=a;return b}
Kb("about:blank");function Lb(a,b){Mb||Nb();Ob||(Mb(),Ob=!0);var c=Pb,d=wb.get();d.set(a,b);c.f?c.f.next=d:c.b=d;c.f=d}
var Mb;function Nb(){if(-1!=String(n.Promise).indexOf("[native code]")){var a=n.Promise.resolve(void 0);Mb=function(){a.then(Qb)}}else Mb=function(){var a=Qb;
!ga(n.setImmediate)||n.Window&&n.Window.prototype&&!z("Edge")&&n.Window.prototype.setImmediate==n.setImmediate?(Db||(Db=Eb()),Db(a)):n.setImmediate(a)}}
var Ob=!1,Pb=new ub;function Qb(){for(var a;a=Pb.remove();){try{a.b.call(a.scope)}catch(b){Cb(b)}ra(wb,a)}Ob=!1}
;function Rb(){this.b="";this.f=Sb}
Rb.prototype.za=!0;Rb.prototype.ya=function(){return this.b};
function Tb(a){if(a instanceof Rb&&a.constructor===Rb&&a.f===Sb)return a.b;ca(a);return"type_error:SafeHtml"}
var Sb={};function Ub(a){var b=new Rb;b.b=a;return b}
Ub("<!DOCTYPE html>");Ub("");Ub("<br>");function Vb(a,b){var c;c=b instanceof Fb?b:Jb(b);a.href=Hb(c)}
function Wb(a,b){a.rel="stylesheet";var c;b instanceof yb&&b.constructor===yb&&b.f===zb?c=b.b:(ca(b),c="type_error:TrustedResourceUrl");a.href=c}
...
function Zb(a,b,c){Lb(function(){a.apply(b,c)})}
...
h.G=function(){D.B.G.call(this);this.clear();this.g.length=0};var $b=t("yt.pubsub.instance_")||new D;D.prototype.subscribe=D.prototype.subscribe;D.prototype.unsubscribeByKey=D.prototype.U;D.prototype.publish=D.prototype.M;D.prototype.clear=D.prototype.clear;q("yt.pubsub.instance_",$b,void 0);var ac=t("yt.pubsub.subscribedKeys_")||{};q("yt.pubsub.subscribedKeys_",ac,void 0);var bc=t("yt.pubsub.topicToKeys_")||{};q("yt.pubsub.topicToKeys_",bc,void 0);var cc=t("yt.pubsub.isSynchronous_")||{};q("yt.pubsub.isSynchronous_",cc,void 0);
var dc=t("yt.pubsub.skipSubId_")||null;q("yt.pubsub.skipSubId_",dc,void 0);function ec(a,b,c){var d=fc();if(d){var e=d.subscribe(a,function(){if(!dc||dc!=e){var d=arguments,g;g=function(){ac[e]&&b.apply(c||window,d)};
try{cc[a]?g():x(g,0)}catch(k){Ra(k)}}},c);
...
function nc(a,b){var c=oc(a),d=document.getElementById(c),e=d&&Ya(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){var e=ec(c,b),g=""+ia(b);pc[g]=e}f||(d=qc(a,c,function(){Ya(d,"loaded")||(Wa(d,"loaded","true"),E(c),x(na(jc,c),0))}))}}
...
var lc=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,mc=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/,pc={};var sc=null;function tc(){var a=B("BG_I",null),b=B("BG_IU",null),c=Oa("BG_P",void 0);b?kc(b,function(){sc=new botguard.bg(c)}):a&&(eval(a),sc=new botguard.bg(c))}
function uc(){return null!=sc}
function vc(){return sc?sc.invoke():null}
;var wc=[],xc=!1;function yc(){function a(){xc=!0;"google_ad_status"in window?gb("DCLKSTAT",1):gb("DCLKSTAT",2)}
kc("//static.doubleclick.net/instream/ad_status.js",a);wc.push(xb(function(){xc||"google_ad_status"in window||(rc("//static.doubleclick.net/instream/ad_status.js",a),gb("DCLKSTAT",3))},5E3))}
function zc(){return parseInt(B("DCLKSTAT",0),10)}
...
;function Bc(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;r=m=0}
...
jd.prototype.remove=function(a){this.b.remove(a)};var G;G=F(Cc,"___jsl",Jc());F(G,"I",0);F(G,"hel",10);function kd(){var a=Ec.href,b;if(G.dpo)b=G.h;else{b=G.h;var c=RegExp("([#].*&|[#])jsh=([^&#]*)","g"),d=RegExp("([?#].*&|[?#])jsh=([^&#]*)","g");if(a=a&&(c.exec(a)||d.exec(a)))try{b=decodeURIComponent(a[2])}catch(e){}}return b}
function md(a){var b=F(G,"PQ",[]);G.PQ=[];var c=b.length;if(0===c)a();else for(var d=0,e=function(){++d===c&&a()},f=0;f<c;f++)b[f](e)}
function nd(a){return F(F(G,"H",Jc()),a,Jc())}
;function od(){return z("iPhone")&&!z("iPod")&&!z("iPad")}
;function pd(a){this.b=a}
w(pd,jd);function qd(a){this.data=a}
function rd(a){return!p(a)||a instanceof qd?a:new qd(a)}
pd.prototype.set=function(a,b){pd.B.set.call(this,a,rd(b))};
pd.prototype.f=function(a){a=pd.B.get.call(this,a);if(!p(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
pd.prototype.get=function(a){if(a=this.f(a)){if(a=a.data,!p(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};var sd=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;function td(a){return a.match(sd)}
function ud(a){return a?decodeURI(a):a}
function vd(a){if(a[1]){var b=a[0],c=b.indexOf("#");0<=c&&(a.push(b.substr(c)),a[0]=b=b.substr(0,c));c=b.indexOf("?");0>c?a[1]="?":c==b.length-1&&(a[1]=void 0)}return a.join("")}
function wd(a,b,c){if(da(b))for(var d=0;d<b.length;d++)wd(a,String(b[d]),c);else null!=b&&c.push("&",a,""===b?"":"=",encodeURIComponent(String(b)))}
function xd(a,b,c){for(c=c||0;c<b.length;c+=2)wd(b[c],b[c+1],a);return a}
function yd(a,b){for(var c in b)wd(c,b[c],a);return a}
function zd(a){a=yd([],a);a[0]="";return a.join("")}
function Ad(a,b){return vd(2==arguments.length?xd([a],arguments[1],0):xd([a],arguments,1))}
;function Bd(a){return B("EXPERIMENT_FLAGS",{})[a]}
;function Cd(){return{apiaryHost:B("APIARY_HOST",void 0),Jb:B("APIARY_HOST_FIRSTPARTY",void 0),gapiHintOverride:B("GAPI_HINT_OVERRIDE"),gapiHintParams:B("GAPI_HINT_PARAMS",void 0),innertubeApiKey:B("INNERTUBE_API_KEY",void 0),innertubeApiVersion:B("INNERTUBE_API_VERSION",void 0),cc:B("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:B("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),ec:B("INNERTUBE_CONTEXT_HL",void 0),dc:B("INNERTUBE_CONTEXT_GL",void 0),Qc:B("XHR_APIARY_HOST",void 0)}}
function Dd(a){a={client:{hl:a.ec,gl:a.dc,clientName:a.cc,clientVersion:a.innertubeContextClientVersion}};B("DELEGATED_SESSION_ID")&&(a.user={onBehalfOfUser:B("DELEGATED_SESSION_ID")});return a}
...
w(Rd,pd);Rd.prototype.set=function(a,b,c){if(b=rd(b)){if(c){if(c<pa()){Rd.prototype.remove.call(this,a);return}b.expiration=c}b.creation=pa()}Rd.B.set.call(this,a,b)};
...
function Td(a,b){var c=a.split("#",2);a=c[0];var c=1<c.length?"#"+c[1]:"",d=a.split("?",2);a=d[0];var d=Sd(d[1]||""),e;for(e in b)d[e]=b[e];return vd(yd([a],d))+c}
...
var ee=/^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,de=/\/cb=/g,ce=/\/\//g;function je(){var a=kd();if(!a)throw Error("Bad hint");return a}
...
function re(a,b,c){se(function(){var c;c=b===kd()?F(Kc,"_",Jc()):Jc();c=F(nd(b),"_",c);a(c)},c)}
function te(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);qe(a,c);var d=a?a.split(":"):[],e=c.h||je(),f=F(G,"ah",Jc());if(f["::"]&&d.length){for(var g=[],k=null;k=d.shift();){var l=k.split("."),l=f[k]||f[l[1]&&"ns:"+l[0]||""]||e,m=g.length&&g[g.length-1]||null,r=m;m&&m.hint==l||(r={hint:l,features:[]},g.push(r));r.features.push(k)}var M=g.length;if(1<M){var V=c.callback;V&&(c.callback=function(){0==--M&&V()})}for(;d=g.shift();)ue(d.features,c,d.hint)}else ue(d||[],c,e)}
function ue(a,b,c){function d(a,b){if(M)return 0;Cc.clearTimeout(r);V.push.apply(V,A);var d=((Kc||{}).config||{}).update;d?d(f):f&&F(G,"cu",[]).push(f);if(b){Id("me0",a,H);try{re(b,c,m)}finally{Id("me1",a,H)}}return 1}
a=Ic(a)||[];var e=b.callback,f=b.config,g=b.timeout,k=b.ontimeout,l=b.onerror,m=void 0;"function"==typeof l&&(m=l);var r=null,M=!1;if(g&&!k||!g&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var l=F(nd(c),"r",[]).sort(),V=F(nd(c),"L",[]).sort(),H=[].concat(l);0<g&&(r=Cc.setTimeout(function(){M=!0;k()},g));
var A=me(a,V);if(A.length){var A=me(a,l),wa=F(G,"CP",[]),Y=wa.length;wa[Y]=function(a){function b(){var a=wa[Y+1];a&&a()}
function c(b){wa[Y]=null;d(A,a)&&md(function(){e&&e();b()})}
if(!a)return 0;Id("ml1",A,H);0<Y&&wa[Y-1]?wa[Y]=function(){c(b)}:c(b)};
if(A.length){var ld="loaded_"+G.I++;Kc[ld]=function(a){wa[Y](a);Kc[ld]=null};
a=be(c,A,"gapi."+ld,l);l.push.apply(l,A);Id("ml0",A,H);b.sync||Cc.___gapisync?oe(a):pe(a)}else wa[Y](Fc)}else d(A)&&e&&e()}
...
K.prototype.round=function(){this.l=Math.round(this.l);this.o=Math.round(this.o);return this};var Be=z("Opera"),L=z("Trident")||z("MSIE"),Ce=z("Edge"),De=Ce||L,Ee=z("Gecko")&&!(-1!=db.toLowerCase().indexOf("webkit")&&!z("Edge"))&&!(z("Trident")||z("MSIE"))&&!z("Edge"),Fe=-1!=db.toLowerCase().indexOf("webkit")&&!z("Edge"),Ge=z("Macintosh"),He=z("Windows"),Ie=z("Android"),Je=od(),Ke=z("iPad"),Le=z("iPod");function Me(){var a=n.document;return a?a.documentMode:void 0}
var Ne;a:{var Oe="",Pe=function(){var a=db;if(Ee)return/rv\:([^\);]+)(\)|;)/.exec(a);if(Ce)return/Edge\/([\d\.]+)/.exec(a);if(L)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(Fe)return/WebKit\/(\S+)/.exec(a);if(Be)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
...
var Te;var Ue=n.document;Te=Ue&&L?Me()||("CSS1Compat"==Ue.compatMode?parseInt(Re,10):5):void 0;var Ve=!Ee&&!L||L&&9<=Number(Te)||Ee&&Se("1.9.1"),We=L&&!Se("9");function Xe(a){this.b=a}
w(Xe,Rd);function Ye(){}
w(Ye,bd);Ye.prototype.fa=function(){var a=0;ye(this.ea(!0),function(){a++});
return a};
Ye.prototype.clear=function(){var a=ze(this.ea(!0)),b=this;C(a,function(a){b.remove(a)})};var Ze=z("Firefox"),$e=od()||z("iPod"),af=z("iPad"),bf=z("Android")&&!(Bb()||z("Firefox")||z("Opera")||z("Silk")),cf=Bb(),df=Ab()&&!(od()||z("iPad")||z("iPod"));function ef(a){ff();var b=new yb;b.b=a;return b}
var ff=aa;function gf(a,b){this.b=0;this.D=void 0;this.i=this.f=this.g=null;this.w=this.A=!1;if(a!=aa)try{var c=this;a.call(b,function(a){hf(c,2,a)},function(a){hf(c,3,a)})}catch(d){hf(this,3,d)}}
function jf(){this.next=this.context=this.f=this.g=this.b=null;this.i=!1}
jf.prototype.reset=function(){this.context=this.f=this.g=this.b=null;this.i=!1};
var kf=new qa(function(){return new jf},function(a){a.reset()},100);
function lf(a,b,c){var d=kf.get();d.g=a;d.f=b;d.context=c;return d}
function mf(a){if(a instanceof gf)return a;var b=new gf(aa);hf(b,2,a);return b}
function nf(a){return new gf(function(b,c){c(a)})}
gf.prototype.then=function(a,b,c){return of(this,ga(a)?a:null,ga(b)?b:null,c)};
Yc(gf);gf.prototype.cancel=function(a){0==this.b&&Lb(function(){var b=new pf(a);qf(this,b)},this)};
function qf(a,b){if(0==a.b)if(a.g){var c=a.g;if(c.f){for(var d=0,e=null,f=null,g=c.f;g&&(g.i||(d++,g.b==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.b&&1==d?qf(c,b):(f?(d=f,d.next==c.i&&(c.i=d),d.next=d.next.next):rf(c),sf(c,e,3,b)))}a.g=null}else hf(a,3,b)}
function tf(a,b){a.f||2!=a.b&&3!=a.b||uf(a);a.i?a.i.next=b:a.f=b;a.i=b}
function of(a,b,c,d){var e=lf(null,null,null);e.b=new gf(function(a,g){e.g=b?function(c){try{var e=b.call(d,c);a(e)}catch(m){g(m)}}:a;
e.f=c?function(b){try{var e=c.call(d,b);!p(e)&&b instanceof pf?g(b):a(e)}catch(m){g(m)}}:g});
e.b.g=a;tf(a,e);return e.b}
gf.prototype.H=function(a){this.b=0;hf(this,2,a)};
gf.prototype.K=function(a){this.b=0;hf(this,3,a)};
function hf(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.H,g=a.K;if(e instanceof gf)tf(e,lf(f||aa,g||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(m){k=!1}else k=!1;if(k)e.then(f,g,a),d=!0;else{if(ha(e))try{var l=e.then;if(ga(l)){vf(e,l,f,g,a);d=!0;break a}}catch(m){g.call(a,m);d=!0;break a}d=!1}}}d||(a.D=c,a.b=b,a.g=null,uf(a),3!=b||c instanceof pf||wf(a,c))}}
function vf(a,b,c,d,e){function f(a){k||(k=!0,d.call(e,a))}
function g(a){k||(k=!0,c.call(e,a))}
var k=!1;try{b.call(a,g,f)}catch(l){f(l)}}
function uf(a){a.A||(a.A=!0,Lb(a.F,a))}
function rf(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.i=null);return b}
gf.prototype.F=function(){for(var a;a=rf(this);)sf(this,a,this.b,this.D);this.A=!1};
function sf(a,b,c,d){if(3==c&&b.f&&!b.i)for(;a&&a.w;a=a.g)a.w=!1;if(b.b)b.b.g=null,xf(b,c,d);else try{b.i?b.g.call(b.context):xf(b,c,d)}catch(e){yf.call(null,e)}ra(kf,b)}
function xf(a,b,c){2==b?a.g.call(a.context,c):a.f&&a.f.call(a.context,c)}
function wf(a,b){a.w=!0;Lb(function(){a.w&&yf.call(null,b)})}
var yf=Cb;function pf(a){sa.call(this,a)}
w(pf,sa);pf.prototype.name="cancel";function zf(a){this.b=a}
w(zf,Ye);h=zf.prototype;h.isAvailable=function(){if(!this.b)return!1;try{return this.b.setItem("__sak","1"),this.b.removeItem("__sak"),!0}catch(a){return!1}};
...
h.key=function(a){return this.b.key(a)};function Af(a){return a?new Bf(Cf(a)):ta||(ta=new Bf)}
function N(a){return u(a)?document.getElementById(a):a}
function Df(a){var b=document;return u(a)?b.getElementById(a):a}
function Ef(a,b){var c=b||document;return c.querySelectorAll&&c.querySelector?c.querySelectorAll("."+a):Ff("*",a,b)}
function O(a,b){var c=b||document,d=null;c.getElementsByClassName?d=c.getElementsByClassName(a)[0]:c.querySelectorAll&&c.querySelector?d=c.querySelector("."+a):d=Ff("*",a,b)[0];return d||null}
function Ff(a,b,c){var d=document;c=c||d;a=a&&"*"!=a?String(a).toUpperCase():"";if(c.querySelectorAll&&c.querySelector&&(a||b))return c.querySelectorAll(a+(b?"."+b:""));if(b&&c.getElementsByClassName){c=c.getElementsByClassName(b);if(a){for(var d={},e=0,f=0,g;g=c[f];f++)a==g.nodeName&&(d[e++]=g);d.length=e;return d}return c}c=c.getElementsByTagName(a||"*");if(b){d={};for(f=e=0;g=c[f];f++)a=g.className,"function"==typeof a.split&&mb(a.split(/\s+/),b)&&(d[e++]=g);d.length=e;return d}return c}
function Gf(a,b){ua(b,function(b,d){"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:Hf.hasOwnProperty(d)?a.setAttribute(Hf[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})}
var Hf={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};function If(a){a=a.document;a=Jf(a)?a.documentElement:a.body;return new Uc(a.clientWidth,a.clientHeight)}
function Kf(a){var b=Lf(a);a=Mf(a);return L&&Se("10")&&a.pageYOffset!=b.scrollTop?new K(b.scrollLeft,b.scrollTop):new K(a.pageXOffset||b.scrollLeft,a.pageYOffset||b.scrollTop)}
function Lf(a){return a.scrollingElement?a.scrollingElement:!Fe&&Jf(a)?a.documentElement:a.body||a.documentElement}
function Mf(a){return a.parentWindow||a.defaultView}
function Jf(a){return"CSS1Compat"==a.compatMode}
function Nf(a){for(var b;b=a.firstChild;)a.removeChild(b)}
function Of(a){a&&a.parentNode&&a.parentNode.removeChild(a)}
function Pf(a){return Ve&&void 0!=a.children?a.children:ib(a.childNodes,function(a){return 1==a.nodeType})}
function Qf(a){if(!a)return null;if(a.firstChild)return a.firstChild;for(;a&&!a.nextSibling;)a=a.parentNode;return a?a.nextSibling:null}
function Rf(a){if(!a)return null;if(!a.previousSibling)return a.parentNode;for(a=a.previousSibling;a&&a.lastChild;)a=a.lastChild;return a}
function Sf(a){return ha(a)&&1==a.nodeType}
function Tf(a,b){if(!a||!b)return!1;if(a.contains&&1==b.nodeType)return a==b||a.contains(b);if("undefined"!=typeof a.compareDocumentPosition)return a==b||!!(a.compareDocumentPosition(b)&16);for(;b&&a!=b;)b=b.parentNode;return b==a}
function Cf(a){return 9==a.nodeType?a:a.ownerDocument||a.document}
function Uf(a,b){if("textContent"in a)a.textContent=b;else if(3==a.nodeType)a.data=b;else if(a.firstChild&&3==a.firstChild.nodeType){for(;a.lastChild!=a.firstChild;)a.removeChild(a.lastChild);a.firstChild.data=b}else Nf(a),a.appendChild(Cf(a).createTextNode(String(b)))}
function Vf(a,b){var c=[];return Wf(a,b,c,!0)?c[0]:void 0}
function Wf(a,b,c,d){if(null!=a)for(a=a.firstChild;a;){if(b(a)&&(c.push(a),d)||Wf(a,b,c,d))return!0;a=a.nextSibling}return!1}
var Xf={SCRIPT:1,STYLE:1,HEAD:1,IFRAME:1,OBJECT:1},Yf={IMG:" ",BR:"\n"};function Zf(a){var b;if((b="A"==a.tagName||"INPUT"==a.tagName||"TEXTAREA"==a.tagName||"SELECT"==a.tagName||"BUTTON"==a.tagName?!a.disabled&&(!$f(a)||ag(a)):$f(a)&&ag(a))&&L){var c;!ga(a.getBoundingClientRect)||L&&null==a.parentElement?c={height:a.offsetHeight,width:a.offsetWidth}:c=a.getBoundingClientRect();a=null!=c&&0<c.height&&0<c.width}else a=b;return a}
function $f(a){return L&&!Se("9")?(a=a.getAttributeNode("tabindex"),null!=a&&a.specified):a.hasAttribute("tabindex")}
function ag(a){a=a.tabIndex;return fa(a)&&0<=a&&32768>a}
function bg(a){if(We&&null!==a&&"innerText"in a)a=a.innerText.replace(/(\r\n|\r|\n)/g,"\n");else{var b=[];cg(a,b,!0);a=b.join("")}a=a.replace(/ \xAD /g," ").replace(/\xAD/g,"");a=a.replace(/\u200B/g,"");We||(a=a.replace(/ +/g," "));" "!=a&&(a=a.replace(/^\s*/,""));return a}
function cg(a,b,c){if(!(a.nodeName in Xf))if(3==a.nodeType)c?b.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g,"")):b.push(a.nodeValue);else if(a.nodeName in Yf)b.push(Yf[a.nodeName]);else for(a=a.firstChild;a;)cg(a,b,c),a=a.nextSibling}
function dg(a,b,c,d){if(!b&&!c)return null;var e=b?String(b).toUpperCase():null;return eg(a,function(a){return(!e||a.nodeName==e)&&(!c||u(a.className)&&mb(a.className.split(/\s+/),c))},!0,d)}
function P(a,b){return dg(a,null,b,void 0)}
function eg(a,b,c,d){a&&!c&&(a=a.parentNode);for(c=0;a&&(null==d||c<=d);){if(b(a))return a;a=a.parentNode;c++}return null}
function Bf(a){this.b=a||n.document||document}
h=Bf.prototype;h.getElementsByTagName=function(a,b){return(b||this.b).getElementsByTagName(String(a))};
h.createElement=function(a){return this.b.createElement(String(a))};
h.appendChild=function(a,b){a.appendChild(b)};
h.isElement=Sf;h.contains=Tf;function fg(){var a=null;try{a=window.localStorage||null}catch(b){}this.b=a}
w(fg,zf);function gg(){var a=null;try{a=window.sessionStorage||null}catch(b){}this.b=a}
w(gg,zf);function hg(a){this.b=a||Cd();ig||(ig=jg(this.b))}
var ig=null;function jg(a){return(new gf(function(b){try{var c={gapiHintOverride:a.gapiHintOverride,_c:{jsl:{h:a.gapiHintParams}},callback:b},d=ga(c)?{callback:c}:c||{};d._c&&d._c.jsl&&d._c.jsl.h||Ea(d,{_c:{jsl:{h:B("GAPI_HINT_PARAMS",void 0)}}});if(d.gapiHintOverride||B("GAPI_HINT_OVERRIDE")){var e;var f=document.location.href;if(-1!=f.indexOf("?")){var f=(f||"").split("#")[0],g=f.split("?",2);e=Sd(1<g.length?g[1]:g[0])}else e={};var k=e.gapi_jsh;k&&Ea(d,{_c:{jsl:{h:k}}})}te("client",d)}catch(l){Ra(l)}})).then(function(){})}
hg.prototype.i=function(){var a=t("gapi.config.update");a("googleapis.config/auth/useFirstPartyAuth",!0);var b=this.b.apiaryHost;/^[\s\xa0]*$/.test(null==b?"":String(b))||a("googleapis.config/root",(-1==b.indexOf("://")?"//":"")+b);b=this.b.Jb;/^[\s\xa0]*$/.test(null==b?"":String(b))||a("googleapis.config/root-1p",(-1==b.indexOf("://")?"//":"")+b);a("googleapis.config/sessionIndex",B("SESSION_INDEX"));t("gapi.client.setApiKey")(this.b.innertubeApiKey)};
hg.prototype.f=function(){return{context:Dd(this.b)}};
hg.prototype.g=function(a,b,c){var d,e=!1;0<c.timeout&&(d=x(function(){e||(e=!0,c.$&&c.$())},c.timeout));
kg(this,a,b,function(a){if(!e)if(e=!0,d&&Qa(d),a)c.O&&c.O(a);else if(c.onError)c.onError()})};
function kg(a,b,c,d){var e={path:"/youtubei/"+a.b.innertubeApiVersion+"/"+b,headers:{"X-Goog-Visitor-Id":B("VISITOR_DATA")},method:"POST",body:Oc(c)},f=v(a.i,a);ig.then(function(){f();t("gapi.client.request")(e).execute(d||aa)})}
;function lg(a){var b=a.__yt_uid_key;b||(b=mg(),a.__yt_uid_key=b);return b}
var mg=t("yt.dom.getNextId_");if(!mg){mg=function(){return++ng};
q("yt.dom.getNextId_",mg,void 0);var ng=0}function og(a,b){a=N(a);b=N(b);return!!eg(a,function(a){return a===b},!0,void 0)}
function pg(a,b){var c=Ff(a,null,b);return c.length?c[0]:null}
function qg(){var a=document,b;kb(["fullscreenElement","webkitFullscreenElement","mozFullScreenElement","msFullscreenElement"],function(c){b=a[c];return!!b});
return b}
function rg(){Od(document.body,"hide-players",!1);C(Ef("preserve-players"),function(a){Md(a,"preserve-players")})}
;var sg={log_event:"events",log_interaction:"interactions"},tg={},ug={},vg=0,Aa=t("yt.logging.transport.logsQueue_")||{};q("yt.logging.transport.logsQueue_",Aa,void 0);function wg(a,b){Aa[a.endpoint]=Aa[a.endpoint]||[];var c=Aa[a.endpoint];c.push(a.ib);ug[a.endpoint]=b;c.length>=(Number(Bd("web_logging_max_batch")||0)||20)?xg():yg()}
function xg(){Qa(vg);if(!za()){for(var a in Aa){var b=tg[a];if(!b){b=ug[a];if(!b)continue;b=new b;tg[a]=b}var c=b.f();c.requestTimeMs=Math.round(Ua());c[sg[a]]=Aa[a];b.g(a,c,{});delete Aa[a]}za()||yg()}}
function yg(){Qa(vg);vg=x(xg,Oa("LOGGING_BATCH_TIMEOUT",1E4))}
;function zg(){if(!Ag&&!Bg||!window.JSON)return null;var a;try{a=Ag.get("yt-player-two-stage-token")}catch(b){}if(!u(a))try{a=Bg.get("yt-player-two-stage-token")}catch(b){}if(!u(a))return null;try{a=JSON.parse(a,void 0)}catch(b){}return a}
var Bg,Cg=new fg;Bg=Cg.isAvailable()?new Xe(Cg):null;var Ag,Dg=new gg;Ag=Dg.isAvailable()?new Xe(Dg):null;var ya=t("yt.events.listeners_")||{};q("yt.events.listeners_",ya,void 0);var Eg=t("yt.events.counter_")||{count:0};q("yt.events.counter_",Eg,void 0);function Fg(a,b,c,d){a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return xa(function(e){return e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function Q(a,b,c,d){if(!a||!a.addEventListener&&!a.attachEvent)return"";d=!!d;var e=Fg(a,b,c,d);if(e)return e;var e=++Eg.count+"",f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document),g;g=f?function(d){d=new cd(d);if(!eg(d.relatedTarget,function(b){return b==a},!0))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new cd(b);
b.currentTarget=a;return c.call(a,b)};
g=Pa(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),a.addEventListener(b,g,d)):a.attachEvent("on"+b,g);ya[e]=[a,b,c,g,d];return e}
function Gg(a,b,c){return Hg(a,b,function(a){return I(a,c)})}
function Hg(a,b,c){var d=a||document;return Q(d,"click",function(a){var e=eg(a.target,function(a){return a===d||c(a)},!0);
e&&e!==d&&!e.disabled&&(a.currentTarget=e,b.call(e,a))})}
function Ig(a){a&&("string"==typeof a&&(a=[a]),C(a,function(a){if(a in ya){var b=ya[a],d=b[0],e=b[1],f=b[3],b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete ya[a]}}))}
...
;function Lg(a,b,c,d,e,f,g){function k(){4==(l&&"readyState"in l?l.readyState:0)&&b&&Pa(b)(l)}
var l=hd&&hd();if(!("open"in l))return null;"onloadend"in l?l.addEventListener("loadend",k,!1):l.onreadystatechange=k;c=(c||"GET").toUpperCase();d=d||"";l.open(c,a,!0);f&&(l.responseType=f);g&&(l.withCredentials=!0);f="POST"==c;if(e=Mg(a,e))for(var m in e)l.setRequestHeader(m,e[m]),"content-type"==m.toLowerCase()&&(f=!1);f&&l.setRequestHeader("Content-Type","application/x-www-form-urlencoded");l.send(d);return l}
function Mg(a,b){b=b||{};var c;c||(c=window.location.href);var d=td(a)[1]||null,e=ud(td(a)[3]||null);d&&e?(d=c,c=td(a),d=td(d),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?ud(td(c)[3]||null)==e&&(Number(td(c)[4]||null)||null)==(Number(td(a)[4]||null)||null):!0;for(var f in Ng){if((e=d=B(Ng[f]))&&!(e=c)){var e=f,g=B("CORS_HEADER_WHITELIST")||{},k=ud(td(a)[3]||null);e=k?(g=g[k])?mb(g,e):!1:!0}e&&(b[f]=d)}return b}
function Og(a,b){b.method="POST";b.J||(b.J={});Pg(a,b)}
function Qg(a,b){var c=B("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.ed&&(!ud(td(a)[3]||null)||b.withCredentials||ud(td(a)[3]||null)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.J&&b.J[c])}
function Pg(a,b){var c=b.format||"JSON";b.ac&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=B("XSRF_FIELD_NAME",void 0),e=B("XSRF_TOKEN",void 0),f=b.Da;f&&(f[d]&&delete f[d],a=Td(a,f||{}));var g=b.postBody||"",f=b.J;Qg(a,b)&&(f||(f={}),f[d]=e);f&&u(g)&&(d=Sd(g),Ea(d,f),g=b.jb&&"JSON"==b.jb?JSON.stringify(d):zd(d));var k=!1,l,m=Lg(a,function(a){if(!k){k=!0;l&&Qa(l);var d=id(a),e=null;if(d||400<=a.status&&500>a.status)e=
Rg(c,a,b.dd);if(d)a:if(204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||n;d?b.O&&b.O.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Ba&&b.Ba.call(f,a,e)}},b.method,g,b.headers,b.responseType,b.withCredentials);
b.$&&0<b.timeout&&(l=x(function(){k||(k=!0,m.abort(),Qa(l),b.$.call(b.context||n,m))},b.timeout))}
function Rg(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=Nc(a));break;case "XML":if(b=(b=b.responseXML)?Sg(b):null)d={},C(b.getElementsByTagName("*"),function(a){d[a.tagName]=Tg(a)})}c&&Ug(d);
return d}
function Ug(a){if(ha(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d;d=Ub(a[b]);a[c]=d}else Ug(a[b])}}
function Sg(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Tg(a){var b="";C(a.childNodes,function(a){b+=a.nodeValue});
return b}
var Ng={"X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"};var Vg={},Wg=0;function Xg(){this.b=Cd()}
Xg.prototype.f=function(){return{context:Dd(this.b)}};
...
c=f&&d&&e?[e,Ed(Ac(f),d,c||null)].join(" "):null;break a}c=null}c&&(b.headers.Authorization=c,b.headers["X-Goog-AuthUser"]=B("SESSION_INDEX",0));Og("//"+this.b.Qc+("/youtubei/"+this.b.innertubeApiVersion+"/"+a)+"?alt=json&key="+this.b.innertubeApiKey,b)};function Yg(){if(null==t("_lact",window)){var a=parseInt(B("LACT"),10),a=isFinite(a)?pa()-Math.max(a,0):-1;q("_lact",a,window);-1==a&&Zg();Q(document,"keydown",Zg);Q(document,"keyup",Zg);Q(document,"mousedown",Zg);Q(document,"mouseup",Zg);ec("page-mouse",Zg);ec("page-scroll",Zg);ec("page-resize",Zg)}}
function Zg(){null==t("_lact",window)&&(Yg(),t("_lact",window));var a=pa();q("_lact",a,window);E("USER_ACTIVE")}
function $g(){var a=t("_lact",window);return null==a?-1:Math.max(pa()-a,0)}
;function ah(a,b,c,d){var e={};e.eventTimeMs=Math.round(d||Ua());e[a]=b;Bd("web_gel_lact")&&(e.context={lastActivityMs:$g()});wg({endpoint:"log_event",ib:e},c)}
...
function ch(a,b,c){b.eventTimeMs=Math.round(Ua());b.lactMs=$g();c&&(b.clientData=fh(c));wg({endpoint:"log_interaction",ib:b},a)}
...
;function dh(){return Bd("enable_youtubei_innertube")?Xg:hg}
;function gh(){var a=Oa("ROOT_VE_TYPE",void 0);return a?new ed(void 0,a,void 0):null}
function hh(){var a=B("client-screen-nonce",void 0);a||(a=B("EVENT_ID",void 0));return a}
;var ih=pa().toString();function jh(a){var b,c;b=void 0===b?{}:b;c=void 0===c?"":c;var d=window.location;a=vd(yd([a],b))+c;a=a instanceof Fb?a:Jb(a);d.href=Hb(a)}
function kh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Oa("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){var d=a,e=B("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=ud(td(window.location.href)[3]||null);f&&e.push(f);f=ud(td(d)[3]||null);if(mb(e,f)||!f&&0==d.lastIndexOf("/",0))if(Bd("autoescape_tempdata_url")&&(e=document.createElement("a"),Vb(e,d),d=e.href),d){var f=td(d),d=f[5],e=f[6],f=f[7],g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
hh();d="ST-"+Ja(d).toString(36);e=b?zd(b):"";Xc.set(""+d,e,5,"/","youtube.com");b&&(b=b.itct||b.ved,d=t("yt.logging.screen.storeParentElement"),b&&d&&d(new ed(b)))}}}if(c)return!1;(window.ytspf||{}).enabled?spf.navigate(a):jh(a);return!0}
...
10)||0;a=[c,d,e]}else a=[0,0,0];this.i=b;b=a;this.b=b[0];this.f=b[1];this.g=b[2];if(0>=this.b){var g,k,l,m;if(Va)try{g=new ActiveXObject("ShockwaveFlash.ShockwaveFlash")}catch(r){g=null}else l=document.body,m=document.createElement("object"),m.setAttribute("type","application/x-shockwave-flash"),g=l.appendChild(m);if(g&&"GetVariable"in g)try{k=g.GetVariable("$version")}catch(r){k=""}l&&m&&l.removeChild(m);(g=k||"")?(g=g.split(" ")[1].split(","),g=[parseInt(g[0],10)||0,parseInt(g[1],10)||0,parseInt(g[2],
...
;function th(){y.call(this);this.b=new D;ab(this,na(bb,this.b))}
w(th,y);th.prototype.subscribe=function(a,b,c){return this.C()?0:this.b.subscribe(a,b,c)};
...
function zh(a,b){var c=Cf(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""}
...
function Ch(a){if(L&&!(8<=Number(Te)))return a.offsetParent;var b=Cf(a),c=Ah(a,"position"),d="fixed"==c||"absolute"==c;for(a=a.parentNode;a&&a!=b;a=a.parentNode)if(11==a.nodeType&&a.host&&(a=a.host),c=Ah(a,"position"),d=d&&"static"==c&&a!=b.documentElement&&a!=b.body,!d&&(a.scrollWidth>a.clientWidth||a.scrollHeight>a.clientHeight||"fixed"==c||"absolute"==c||"relative"==c))return a;return null}
function Dh(a){for(var b=new uh(0,Infinity,Infinity,0),c=Af(a),d=c.b.body,e=c.b.documentElement,f=Lf(c.b);a=Ch(a);)if(!(L&&0==a.clientWidth||Fe&&0==a.clientHeight&&a==d)&&a!=d&&a!=e&&"visible"!=Ah(a,"overflow")){var g=Eh(a),k=new K(a.clientLeft,a.clientTop);g.l+=k.l;g.o+=k.o;b.top=Math.max(b.top,g.o);b.right=Math.min(b.right,g.l+a.clientWidth);b.bottom=Math.min(b.bottom,g.o+a.clientHeight);b.left=Math.max(b.left,g.l)}d=f.scrollLeft;f=f.scrollTop;b.left=Math.max(b.left,d);b.top=Math.max(b.top,f);c=
If(Mf(c.b)||window);b.right=Math.min(b.right,d+c.width);b.bottom=Math.min(b.bottom,f+c.height);return 0<=b.top&&0<=b.left&&b.bottom>b.top&&b.right>b.left?b:null}
function Eh(a){var b=Cf(a),c=new K(0,0),d;d=b?Cf(b):document;d=!L||9<=Number(Te)||Jf(Af(d).b)?d.documentElement:d.body;if(a==d)return c;a=Bh(a);b=Kf(Af(b).b);c.l=a.left+b.l;c.o=a.top+b.o;return c}
...
;function Ph(a,b,c,d){y.call(this);this.g=b||null;this.D="*";this.i=c||null;this.b=null;this.channel=d||null;this.K=!!a;this.F=v(this.N,this);window.addEventListener("message",this.F)}
w(Ph,y);Ph.prototype.N=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.g&&a.source!=this.g)&&u(a.data)){var b;try{b=Mc(a.data)}catch(c){return}if(!(null==b||this.K&&(this.b&&this.b!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin?this.i=this.D=a.origin:Ra(Error("MessageEvent origin is null"),"WARNING");this.g=a.source;this.b=b.id;this.f&&(this.f(),this.f=null);break;case "command":this.w&&(this.A&&!mb(this.A,b.func)||this.w(b.func,b.args))}}};
Ph.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.b&&(a.id=this.b);this.channel&&(a.channel=this.channel);try{var d=Oc(a);c.postMessage(d,this.D)}catch(e){Ra(e,"WARNING")}}};
Ph.prototype.G=function(){window.removeEventListener("message",this.F);Ph.B.G.call(this)};function Qh(a,b,c){Ph.call(this,a,b,c||B("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.A=this.f=this.w=null}
w(Qh,Ph);function Rh(){var a=qg();return a?a:null}
;function Sh(a){if(window.spf){var b=a.match(Th);spf.style.load(a,b?b[1]:"",void 0)}else Uh(a)}
function Uh(a){var b=Vh(a),c=document.getElementById(b),d=c&&Ya(c,"loaded");d||c&&!d||(c=Wh(a,b,function(){Ya(c,"loaded")||(Wa(c,"loaded","true"),E(b),x(na(jc,b),0))}))}
function Wh(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=ef(a);Wb(d,a);(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function Vh(a){var b=document.createElement("a");Vb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ja(a)}
var Th=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;var Xh={},Yh=0;function Zh(a,b){a&&(B("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)?Lg(a,b):$h(a,b))}
function $h(a,b){var c=new Image,d=""+Yh++;Xh[d]=c;c.onload=c.onerror=function(){b&&Xh[d]&&b();delete Xh[d]};
c.src=a}
;function ai(){var a=Ca(bi);return new gf(function(b,c){a.O=function(a){id(a)?b(a):c(new ci("Request failed, status="+a.status,"net.badstatus"))};
a.onError=function(){c(new ci("Unknown request error","net.unknown"))};
a.$=function(){c(new ci("Request timed out","net.timeout"))};
Pg("//googleads.g.doubleclick.net/pagead/id",a)})}
function ci(a,b){sa.call(this,a+", errorCode="+b);this.errorCode=b}
w(ci,sa);ci.prototype.name="PromiseAjaxError";var di;var ei=db,ei=ei.toLowerCase();if(-1!=ei.indexOf("android")){var fi=ei.match(/android\D*(\d\.\d)[^\;|\)]*[\;\)]/);if(fi)di=Number(fi[1]);else{var gi={cupcake:1.5,donut:1.6,eclair:2,froyo:2.2,gingerbread:2.3,honeycomb:3,"ice cream sandwich":4,jellybean:4.1,kitkat:4.4,lollipop:5.1,marshmallow:6,nougat:7.1},hi=[],ii=0,ji;for(ji in gi)hi[ii++]=ji;var ki=ei.match("("+hi.join("|")+")");di=ki?gi[ki[0]]:0}}else di=void 0;var li=db,mi=li.match(/\((BB10|PlayBook|BlackBerry);/);!mi||2>mi.length||li.match(/Version\/(\d+\.\d+)/);db.match(/Mozilla\/[\d\.]+ \(Mobile;.* rv:([\d\.]+)\) Gecko\/[\d\.]+ Firefox\/[\d\.]+/);var ni;var oi=db,pi=oi.match(/\((iPad|iPhone|iPod)( Simulator)?;/);if(!pi||2>pi.length)ni=void 0;else{var qi=oi.match(/\((iPad|iPhone|iPod)( Simulator)?; (U; )?CPU (iPhone )?OS (\d+_\d)[_ ]/);ni=qi&&6==qi.length?Number(qi[5].replace("_",".")):0}0<=ni&&0<=db.search("Safari")&&db.search("Version");var ri=['video/mp4; codecs="avc1.42001E, mp4a.40.2"','video/webm; codecs="vp8.0, vorbis"'],si=['audio/mp4; codecs="mp4a.40.2"'];L&&Se("9");!Fe||Se("528");Ee&&Se("1.9b")||L&&Se("8")||Be&&Se("9.5")||Fe&&Se("528");Ee&&!Se("8")||L&&Se("9");function ti(a){y.call(this);this.b=[];this.f=a||this}
w(ti,y);function ui(a,b,c,d){d=Pa(v(d,a.f));d={target:b,name:c,va:d};b.addEventListener(c,d.va,void 0);a.b.push(d)}
...
w(zi,R);var Ai=new S("timing-sent",zi);var Bi=t("yt.pubsub2.instance_")||new D;D.prototype.subscribe=D.prototype.subscribe;D.prototype.unsubscribeByKey=D.prototype.U;D.prototype.publish=D.prototype.M;D.prototype.clear=D.prototype.clear;q("yt.pubsub2.instance_",Bi,void 0);var Ci=t("yt.pubsub2.subscribedKeys_")||{};q("yt.pubsub2.subscribedKeys_",Ci,void 0);var Di=t("yt.pubsub2.topicToKeys_")||{};q("yt.pubsub2.topicToKeys_",Di,void 0);var Ei=t("yt.pubsub2.isAsync_")||{};q("yt.pubsub2.isAsync_",Ei,void 0);q("yt.pubsub2.skipSubKey_",null,void 0);
function T(a,b){var c=Fi();c&&c.publish.call(c,a.toString(),a,b)}
function Gi(a,b,c){var d=Fi();if(!d)return 0;var e=d.subscribe(a.toString(),function(d,g){if(!window.yt.pubsub2.skipSubKey_||window.yt.pubsub2.skipSubKey_!=e){var f=function(){if(Ci[e])try{if(g&&a instanceof S&&a!=d)try{g=xi(a.b,g)}catch(l){throw l.message="yt.pubsub2 cross-binary conversion error for "+a.toString()+": "+l.message,l;}b.call(c||window,g)}catch(l){Ra(l)}};
Ei[a.toString()]?t("yt.scheduler.instance")?xb(f,void 0):x(f,0):f()}});
...
;function Ii(a,b,c){y.call(this);this.b=a;this.i=b||0;this.f=c;this.g=v(this.Pb,this)}
w(Ii,y);h=Ii.prototype;h.ga=0;h.G=function(){Ii.B.G.call(this);this.stop();delete this.b;delete this.f};
...
function Oi(a,b){if(!b&&"_"!=a[0]){var c=a;yi.mark&&(0==c.lastIndexOf("mark_",0)||(c="mark_"+c),yi.mark(c))}var c=Pi(),d=b||Ua();c[a]&&(c["_"+a]=c["_"+a]||[c[a]],c["_"+a].push(d));c[a]=d;(Qi()["tick_"+a]=b)||Ua();Bd("csi_on_gel")?(c=Ri(),"_start"==a?ah("latencyActionBaselined",{clientActionNonce:c},Xg,b):ah("latencyActionTicked",{tickName:a,clientActionNonce:c},Xg,b),c=!0):c=!1;if(c=!c)c=!t("yt.timing.pingSent_");if(c&&(d=B("TIMING_ACTION",void 0),c=Pi(),t("yt.timing.ready_")&&d&&c._start&&Si())){var d=
!0,e=B("TIMING_WAIT",[]);if(e.length)for(var f=0,g=e.length;f<g;++f)if(!(e[f]in c)){d=!1;break}d&&Ti()}}
function Ui(){var a=Vi().info.yt_lt="hot_bg";Qi().info_yt_lt=a;if(Bd("csi_on_gel"))if("yt_lt"in Ki){var b={},c=Ki.yt_lt;mb(Mi,c)&&(a=!!a);b[c]=a;a=Ri();b.clientActionNonce=a;ah("latencyActionInfo",b,Xg)}else"yt_lt"in Li||Ra(Error("Unknown label yt_lt logged with GEL CSI."))}
function Si(){var a=Pi();if(a.aft)return a.aft;for(var b=B("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Ti(){if(!Bd("csi_on_gel")){var a=Pi(),b=Vi().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&da(a[d])){var e=d.slice(1);if(e in Ji){var f=jb(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=t("yt.timing.reportbuilder_")){if(f=f(a,b,void 0))Wi(f,e),Xi(),Ni(),Yi(!1,void 0),gb("PREVIOUS_ACTION",B("TIMING_ACTION")),gb("TIMING_ACTION","")}else{var g=B("CSI_SERVICE_NAME","youtube"),f={v:2,s:g,action:B("TIMING_ACTION",void 0)},k=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var l=window.location.protocol+t("ytplayer.config.assets.js");(l=yi.getEntriesByName?yi.getEntriesByName(l)[0]:null)?b.h5jse=Math.round(b.h5jse-l.responseEnd):delete b.h5jse}a.aft=
Si();Zi()&&"youtube"==g&&(Ui(),g=a.vc,l=a.pbs,delete a.aft,b.aft=Math.round(l-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=Ua();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=t("ytdebug.logTiming"))&&a(f,b);Wi(f,e,void 0);T(Ai,new zi(b.aft+(k||0)))}}}
function Wi(a,b,c){if(Bd("debug_csi_data")){var d=t("yt.timing.csiData");d||(d=[],q("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}var d="",e;for(e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b)try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||Zh(a,void 0)}catch(f){Zh(a,void 0)}else Zh(a);Yi(!0,c)}
...
function Xi(){var a={tick:{},info:{}};q("ytcsi.data_",a,void 0);return a}
function Yi(a,b){q("yt.timing."+(b||"")+"pingSent_",a,void 0)}
...
;var aj={"api.invalidparam":2,auth:150,"drm.auth":150,"heartbeat.net":150,"heartbeat.servererror":150,"heartbeat.stop":150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"html5.unsupportedlive":5,"drm.unavailable":5};function bj(a,b){y.call(this);this.A=this.w=a;this.ca=b;this.F=!1;this.f={};this.ka=this.ba=null;this.da=new D;ab(this,na(bb,this.da));this.i={};this.K=this.la=this.g=this.ua=this.b=null;this.ha=!1;this.N=this.D=this.V=this.W=null;this.ma={};this.Hb=["onReady"];this.ia=new ti(this);ab(this,na(bb,this.ia));this.sa=null;this.Ka=NaN;this.ja={};cj(this);this.R("onDetailedError",v(this.sc,this));this.R("onTabOrderChange",v(this.Mb,this));this.R("onTabAnnounce",v(this.La,this));this.R("WATCH_LATER_VIDEO_ADDED",
v(this.tc,this));this.R("WATCH_LATER_VIDEO_REMOVED",v(this.uc,this));Ze||(this.R("onMouseWheelCapture",v(this.pc,this)),this.R("onMouseWheelRelease",v(this.qc,this)));this.R("onAdAnnounce",v(this.La,this));this.T=new ti(this);ab(this,na(bb,this.T));this.ta=!1;this.ra=null}
w(bj,y);var dj=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];h=bj.prototype;h.Ea=function(a,b){this.C()||(ej(this,a),fj(this,b),this.F&&gj(this))};
...
function fj(a,b){if(!a.C()){if(!b){var c;if(!(c=!a.b.html5&&ij(a))){if(!p(a.b.disable.html5)){var d;c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==di)d=!0;else{a:{var e=c;c=t("yt.player.utils.videoElement_");c||(c=document.createElement("VIDEO"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?ri:si,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(g){d="html5.missingapi"}}d=!d}d&&(d=lj(a)||a.b.assets.js);
...
function lj(a){var b=!0,c=kj(a);c&&a.b&&(a=a.b,b=Ya(c,"version")==a.assets.js);return b&&!!t("yt.player.Application.create")}
...
this.i[e]);gj(this);this.la&&this.la(this.f);this.da.M("onReady",this.f)}else this.Ka=x(v(this.aa,this),50)}};
function oj(a,b,c){var d=b[c];return function(){try{return a.sa=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.sa=e,Ra(e,"WARNING"))}}}
function cj(a){a.F=!1;if(a.ka)for(var b in a.i)a.ka(b,a.i[b]);for(var c in a.ja)Qa(parseInt(c,10));a.ja={};a.ba=null;a.ka=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=v(a.R,a);a.f.removeEventListener=v(a.Ec,a);a.f.destroy=v(a.dispose,a);a.f.getLastError=v(a.Ub,a);a.f.getPlayerType=v(a.Vb,a);a.f.getCurrentVideoConfig=v(a.Tb,a);a.f.loadNewVideoConfig=v(a.Ea,a);a.f.isReady=v(a.Rc,a)}
h.Rc=function(){return this.F};
h.R=function(a,b){if(!this.C()){var c=hj(this,b);if(c){if(!mb(this.Hb,a)&&!this.i[a]){var d=pj(this,a);this.ba&&this.ba(a,d)}this.da.subscribe(a,c);"onReady"==a&&this.F&&x(na(c,this.f),0)}}};
...
function pj(a,b){var c="ytPlayer"+b+a.ca;a.i[b]=c;n[c]=function(c){var d=x(function(){if(!a.C()){a.da.M(b,c);var e=a.ja,g=String(d);g in e&&delete e[g]}},0);
Ba(a.ja,String(d))};
return c}
h.Mb=function(a){a=a?Rf:Qf;for(var b=a(document.activeElement);b&&(1!=b.nodeType||b==this.D||b==this.N||(b.focus(),b!=document.activeElement));)b=a(b)};
...
h.pc=function(){this.ta||(cf?(this.ra=Kf(document),ui(this.T,window,"scroll",this.Ac),ui(this.T,this.w,"touchmove",this.yc)):(ui(this.T,this.w,"mousewheel",this.hb),ui(this.T,this.w,"wheel",this.hb)),this.ta=!0)};
...
function nj(a){Oi("dcp");a.cancel();cj(a);a.K=null;a.b&&(a.b.loaded=!1);var b=kj(a);"html5"==mj(a)?a.V=b:b&&b.destroy&&b.destroy();Nf(a.w);vi(a.ia);a.D=null;a.N=null}
h.cancel=function(){this.W&&rc(this.b.assets.js,this.W);Qa(this.Ka);this.ha=!1};
h.G=function(){nj(this);if(this.V&&this.b)try{this.V.destroy()}catch(b){Ra(b)}this.ma=null;for(var a in this.i)n[this.i[a]]=null;this.ua=this.b=this.f=null;delete this.w;delete this.A;bj.B.G.call(this)};var qj={},rj="player_uid_"+(1E9*Math.random()>>>0);function sj(a,b){a=u(a)?Df(a):a;b=ph(b);var c=rj+"_"+ia(a),d=qj[c];if(d)return d.Ea(b),d.f;d=new bj(a,c);qj[c]=d;E("player-added",d.f);ab(d,na(tj,d));x(function(){d.Ea(b)},0);
return d.f}
function tj(a){qj[a.ca]=null}
function uj(a){a=N(a);if(!a)return null;var b=rj+"_"+ia(a),c=qj[b];c||(c=new bj(a,b),qj[b]=c);return c.f}
;var vj=t("yt.abuse.botguardInitialized")||uc;q("yt.abuse.botguardInitialized",vj,void 0);var wj=t("yt.abuse.invokeBotguard")||vc;q("yt.abuse.invokeBotguard",wj,void 0);var xj=t("yt.abuse.dclkstatus.checkDclkStatus")||zc;q("yt.abuse.dclkstatus.checkDclkStatus",xj,void 0);var yj=t("yt.player.exports.navigate")||kh;q("yt.player.exports.navigate",yj,void 0);var zj=t("yt.player.embed")||sj;q("yt.player.embed",zj,void 0);var Aj=t("yt.player.getPlayerByElement")||uj;q("yt.player.getPlayerByElement",Aj,void 0);
var Bj=t("yt.util.activity.init")||Yg;q("yt.util.activity.init",Bj,void 0);var Cj=t("yt.util.activity.getTimeSinceActive")||$g;q("yt.util.activity.getTimeSinceActive",Cj,void 0);var Dj=t("yt.util.activity.setTimestamp")||Zg;q("yt.util.activity.setTimestamp",Dj,void 0);function Ej(a,b,c){fa(a)?(this.date=Fj(a,b||0,c||1),Gj(this,c||1)):ha(a)?(this.date=Fj(a.getFullYear(),a.getMonth(),a.getDate()),Gj(this,a.getDate())):(this.date=new Date(pa()),a=this.date.getDate(),this.date.setHours(0),this.date.setMinutes(0),this.date.setSeconds(0),this.date.setMilliseconds(0),Gj(this,a))}
...
;function kk(a,b,c,d,e,f,g){var k,l;if(k=c.offsetParent){var m="HTML"==k.tagName||"BODY"==k.tagName;m&&"static"==Ah(k,"position")||(l=Eh(k),m||(m=(m=Kh(k))&&Ee?-k.scrollLeft:!m||De&&Se("8")||"visible"==Ah(k,"overflowX")?k.scrollLeft:k.scrollWidth-k.clientWidth-k.scrollLeft,l=Ae(l,new K(m,k.scrollTop))))}k=l||new K;l=Jh(a);if(m=Dh(a)){var r=new vh(m.left,m.top,m.right-m.left,m.bottom-m.top),m=Math.max(l.left,r.left),M=Math.min(l.left+l.width,r.left+r.width);if(m<=M){var V=Math.max(l.top,r.top),r=Math.min(l.top+
l.height,r.top+r.height);V<=r&&(l.left=m,l.top=V,l.width=M-m,l.height=r-V)}}m=Af(a);V=Af(c);if(m.b!=V.b){var M=m.b.body,H;var V=Mf(V.b),r=new K(0,0),A;A=(A=Cf(M))?Mf(A):window;b:{try{Zc(A.parent);H=!0;break b}catch(ld){}H=!1}if(H){H=M;do{var wa=A==V?Eh(H):Fh(H);r.l+=wa.l;r.o+=wa.o}while(A&&A!=V&&A!=A.parent&&(H=A.frameElement)&&(A=A.parent))}H=Ae(r,Eh(M));!L||9<=Number(Te)||Jf(m.b)||(H=Ae(H,Kf(m.b)));l.left+=H.l;l.top+=H.o}a=lk(a,b);b=l.left;a&4?b+=l.width:a&2&&(b+=l.width/2);b=new K(b,l.top+(a&1?
...
;var nk={},ok="ontouchstart"in document;function pk(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return eg(c,function(a){return I(a,b)},!0,d)}
function qk(a){var b="mouseover"==a.type&&"mouseenter"in nk||"mouseout"==a.type&&"mouseleave"in nk,c=a.type in nk||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=nk[b],d;for(d in c.f){var e=pk(b,d,a.target);e&&!eg(a.relatedTarget,function(a){return a==e},!0)&&c.M(d,e,b,a)}}if(b=nk[a.type])for(d in b.f)(e=pk(a.type,d,a.target))&&b.M(d,e,a.type,a)}}
...
h.j=function(a,b){return Ya(a,b)};
function uk(a,b){Wa(a,"tooltip-text",b)}
...
d(b)?e=b:e=Vf(b,d);if(e){e=e.tagName.toLowerCase();var f;"ul"==e?f=this.kc:"table"==e&&(f=this.jc);f&&zk(this,a,b,c,v(f,this))}}};
...
h.jc=function(a,b,c){var d=Bk(this,b);if(d){var e=pg("table",b);b=Ff("td",null,e);d=Ek(d,b,Ff("td",null,pg("tr",e)).length,c);-1!=d&&(Dk(this,a,b[d]),c.preventDefault())}};
h.kc=function(a,b,c){if(40==c.keyCode||38==c.keyCode){var d=Bk(this,b);d&&(b=ib(Ff("li",null,b),hk),Dk(this,a,b[Ek(d,b,1,c)]),c.preventDefault())}};
...
2));d&&(l.o+=Kf(document).o);if(a=Fk(a,b))b=Hh(c),a.style.width=b.width+"px",a.style.height=b.height+"px",kk(e,f,a,g,l,m,197),d&&wh(a,"position","fixed");kk(e,f,c,g,l,m,197)}
...
h.tb=function(a){if(a){var b=yk(this,a);if(b){a.setAttribute("aria-pressed","true");a.setAttribute("aria-expanded","true");b.originalParentNode=b.parentNode;b.activeButtonNode=a;b.parentNode.removeChild(b);var c;this.j(a,"button-has-sibling-menu")?c=a.parentNode:c=Gk(this,a);c.appendChild(b);b.style.minWidth=a.offsetWidth-2+"px";var d=Fk(this,a);d&&c.appendChild(d);(c=!!this.j(a,"button-menu-fixed"))&&(this.f[lg(a).toString()]=b);Ak(this,a,b,c);hc("yt-uix-button-menu-before-show",a,b);ik(b);d&&ik(d);
this.Z(a,"button-menu-action",!0);J(a,U(this,"active"));b=v(this.sb,this,a,!1);d=v(this.sb,this,a,!0);c=v(this.Nc,this,a,void 0);this.b&&yk(this,this.b)==yk(this,a)||wk(this);E("yt-uix-button-menu-show",a);Ig(this.g);this.g=[Q(document,"click",d),Q(document,"contextmenu",b),Q(window,"resize",c)];this.b=a}}};
function Ck(a,b){if(b){var c=yk(a,b);if(c){a.b=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");jk(c);a.Z(b,"button-menu-action",!1);var d=Fk(a,b),e=lg(c).toString();delete a.f[e];x(function(){d&&d.parentNode&&(jk(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}var e=P(b,U(a,"group")),f=[U(a,"active")];
e&&f.push(U(a,"group-active"));Nd(b,f);E("yt-uix-button-menu-hide",b);Ig(a.g);a.g.length=0}}
h.Nc=function(a,b){var c=yk(this,a);if(c){b&&(b instanceof Rb?c.innerHTML=Tb(b):Uf(c,b));var d=!!this.j(a,"button-menu-fixed");Ak(this,a,c,d)}};
h.sb=function(a,b,c){c=Jg(c);var d=P(c,U(this));if(d){var d=yk(this,d),e=yk(this,a);if(d==e)return}var d=P(c,U(this,"menu")),e=d==yk(this,a),f=I(c,U(this,"menu-item")),g=I(c,U(this,"menu-close"));if(!d||e&&(f||g))Ck(this,a),d&&b&&this.j(a,"button-menu-indicate-selected")&&((a=O(U(this,"content"),a))&&Uf(a,bg(c)),Hk(this,d,c))};
function Hk(a,b,c){var d=U(a,"menu-item-selected");C(Ef(d,b),function(a){Md(a,d)});
J(c.parentNode,d)}
...
function xk(a,b){if(a.j(b,"button-toggle")){var c=P(b,U(a,"group")),d=U(a,"toggled"),e=I(b,d);if(c&&a.j(c,"button-toggle-group")){var f=a.j(c,"button-toggle-group");C(Ef(U(a),c),function(a){a!=b||"optional"==f&&e?(Md(a,d),a.removeAttribute("aria-pressed")):(J(b,d),a.setAttribute("aria-pressed","true"))})}else e?b.removeAttribute("aria-pressed"):b.setAttribute("aria-pressed","true"),Qd(b,d)}}
h.click=function(a){if(yk(this,a)){var b=yk(this,a);if(b){var c=P(b.activeButtonNode||b.parentNode,U(this));c&&c!=a?(Ck(this,c),x(v(this.tb,this,a),1)):hk(b)?Ck(this,a):this.tb(a)}a.focus()}this.Z(a,"button-action")};
...
h.show=function(a){var b=this.L(a);if(b){J(b,U(this,"active"));var c=Kk(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;Lk(this,a,c);var d=U(this,"card-visible"),e=this.j(a,"card-delegate-show")&&this.j(b,"card-action");this.Z(b,"card-action",a);this.g=a;jk(c);x(v(function(){e||(ik(c),E("yt-uix-card-show",b,a,c));Mk(c);J(c,d);E("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
function Kk(a,b,c){var d=c||b,e=U(a,"card");c=Nk(a,d);var f=N(U(a,"card")+lg(d));if(f)return a=O(U(a,"card-body"),f),Tf(a,c)||(Of(c),a.appendChild(c)),f;f=document.createElement("div");f.id=U(a,"card")+lg(d);f.className=e;(d=a.j(d,"card-class"))&&Ld(f,d.split(/\s+/));d=document.createElement("div");d.className=U(a,"card-border");b=a.j(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var g=document.createElement("div");
g.className=U(a,"card-body");a=document.createElement("div");a.className="yt-uix-card-body-arrow yt-uix-card-body-arrow-"+b;Of(c);g.appendChild(c);d.appendChild(a);d.appendChild(g);f.appendChild(e);f.appendChild(d);document.body.appendChild(f);return f}
function Lk(a,b,c){var d=a.j(b,"orientation")||"horizontal",e=O(U(a,"anchor"),b)||b,f=a.j(b,"position"),g=!!a.j(b,"force-position"),k=a.j(b,"position-fixed"),d="horizontal"==d,l="bottomright"==f||"bottomleft"==f,m="topright"==f||"bottomright"==f,r,M;m&&l?(M=13,r=8):m&&!l?(M=12,r=9):!m&&l?(M=9,r=12):(M=8,r=13);var V=Kh(document.body),f=Kh(b);V!=f&&(M^=4);var H;d?(f=b.offsetHeight/2-12,H=new K(-12,b.offsetHeight+6)):(f=b.offsetWidth/2-6,H=new K(b.offsetWidth+6,-12));var A=Hh(c),f=Math.min(f,(d?A.height:
A.width)-24-6);6>f&&(f=6,d?H.o+=12-b.offsetHeight/2:H.l+=12-b.offsetWidth/2);A=null;g||(A=10);b=U(a,"card-flip");a=U(a,"card-reverse");Od(c,b,m);Od(c,a,l);A=kk(e,M,c,r,H,null,A);!g&&A&&(A&48&&(m=!m,M^=4,r^=4),A&192&&(l=!l,M^=1,r^=1),Od(c,b,m),Od(c,a,l),kk(e,M,c,r,H));k&&(e=parseInt(c.style.top,10),g=Kf(document).o,wh(c,"position","fixed"),wh(c,"top",e-g+"px"));V&&(c.style.right="",e=Jh(c),e.left=e.left||parseInt(c.style.left,10),g=If(window),c.style.left="",c.style.right=g.width-e.left-e.width+"px");
...
h.P=function(a){if(a=this.L(a)){var b=N(U(this,"card")+lg(a));b&&(Md(a,U(this,"active")),Md(b,U(this,"card-visible")),jk(b),this.g=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(Of(b.cardMask),b.cardMask=null))}};
function Jk(a){a.g&&a.P(a.g)}
h.Mc=function(a,b){var c=this.L(a);if(c){if(b){var d=Nk(this,c);if(!d)return;b instanceof Rb?d.innerHTML=Tb(b):Uf(d,b)}I(c,U(this,"active"))&&(c=Kk(this,a,c),Lk(this,a,c),ik(c),Mk(c))}};
...
;var Ok=!L&&!Ab();function Pk(a,b){return Ok&&a.dataset?b in a.dataset?a.dataset[b]:null:a.getAttribute("data-"+String(b).replace(/([A-Z])/g,"-$1").toLowerCase())}
...
h.unregister=function(){X(this,"keydown",this.Ua);Ig(Rk)};
...
h.na=function(a){if(a)if(Zf(a))a.focus();else{var b=Vf(a,function(a){return Sf(a)?Zf(a):!1});
...
function Tk(a,b){if(b){var c=dg(b,"LI");c&&(J(c,U(a,"highlight")),Rk=Q(b,"blur",v(function(a){Md(a,U(this,"highlight"));Ig(Rk)},a,c)))}}
function Sk(a){if("UL"!=a.tagName.toUpperCase())return[];a=ib(Pf(a),function(a){return"LI"==a.tagName.toUpperCase()});
return ib(jb(a,function(a){return hk(a)?Vf(a,function(a){return Sf(a)?Zf(a):!1}):!1}),function(a){return!!a})}
...
this.i=new D};
h.unregister=function(){X(this,"click",this.Ta);this.f=this.b=null;Ig(tb(va(this.g)));this.g={};ua(this.A,function(a){Of(a)},this);
this.A={};bb(this.i);this.i=null;Vk.B.unregister.call(this)};
h.Ta=function(a,b,c){a&&(b=Yk(this,a),!b.disabled&&og(c.target,b)&&Zk(this,a))};
h.Wb=function(a,b,c){a&&I(a,U(this,"hover"))&&og(c.target,Yk(this,a))&&Zk(this,a,!0)};
...
h.Xb=function(a,b){var c=Jg(b);c&&(og(c,Yk(this,a))||gl(this,c)||hl(this,a))};
h.Sc=function(a,b){var c=Jg(b);if(c){if(gl(this,c)){var d=P(c,U(this,"content")),e=dg(c,"LI");e&&d&&Tf(d,e)&&hc("yt-uix-menu-item-clicked",c);c=P(c,U(this,"close-on-select"));if(!c)return;d=Wk(c)}Xk(this,d||a)}};
function cl(a,b){if(b){var c=P(b,U(a,"content"));c&&C(Ef(U(a),c),function(a){!og(a,b)&&bl(this,a)&&hl(this,a)},a)}}
function Xk(a,b){if(b){var c=[];c.push(b);var d=dl(a,b);d&&(d=Ef(U(a),d),d=pb(d),c=c.concat(d),C(c,function(a){bl(this,a)&&hl(this,a)},a))}}
function hl(a,b){if(b){var c=dl(a,b);Nd(Yk(a,b),[U(a,"trigger-selected"),"yt-uix-button-toggled"]);J(c,U(a,"content-hidden"));var d=dl(a,b);d&&Gf(d,{"aria-expanded":"false"});(d=al(a,b))&&d.parentNode&&Of(d);c&&c==a.b&&(a.f.appendChild(c),a.b=null,a.f=null,a.i&&a.i.M("ROOT_MENU_REMOVED"));E("yt-uix-menu-hide",b);c=ia(b).toString();Ig(a.g[c]);delete a.g[c]}}
h.hc=function(a,b){var c=Jg(b);c&&il(this,a,c)};
h.ic=function(a,b){var c=Jg(b);if(c){var d=Yk(this,a);if(d&&(c=dg(c,"LI")))if(c=bg(c).trim(),d.hasChildNodes()){var e=vk.getInstance();(d=O(U(e,"content"),d))&&Uf(d,c)}else Uf(d,c)}};
function fl(a,b){var c=dl(a,b);if(c){C(c.children,function(a){"LI"==a.tagName&&Gf(a,{role:"menuitem"})});
Gf(c,{"aria-expanded":"true"});var d=c.id;d||(d="aria-menu-id-"+ia(c),c.id=d);(c=Yk(a,b))&&Gf(c,{"aria-controls":d})}}
function il(a,b,c){var d=dl(a,b);d&&I(b,U(a,"checked"))&&(a=dg(c,"LI"))&&(a=O("yt-ui-menu-item-checked-hid",a))&&(C(Ef("yt-ui-menu-item-checked",d),function(a){Pd(a,"yt-ui-menu-item-checked","yt-ui-menu-item-checked-hid")}),Pd(a,"yt-ui-menu-item-checked-hid","yt-ui-menu-item-checked"))}
function bl(a,b){var c=dl(a,b);return c?!I(c,U(a,"content-hidden")):!1}
function el(a){C(Ff("UL",null,a),function(a){a.tabIndex=0;var b=Qk.getInstance();Ld(a,[U(b),U(b,"list")])})}
function dl(a,b){var c=Ya(b,"menu-content-id");return c&&(c=N(c))?(Ld(c,[U(a,"content"),U(a,"content-external")]),c):b==a.f?a.b:O(U(a,"content"),b)}
...
function gl(a,b){return og(b,a.b)||og(b,a.f)}
...
h.unregister=function(){jl.B.unregister.call(this);X(this,"click",this.Qa,"target");X(this,"click",this.Pa,"close");for(var a in this.b)Ig(this.b[a]);this.b={};for(a in this.f)Ig(this.f[a]);this.f={}};
h.Qa=function(a,b,c){c.preventDefault();b=dg(c.target,"button");b&&b.disabled||(a=(b=this.j(a,"card-target"))?Df(b):a,b=this.L(a),this.j(b,"disabled")||(I(b,U(this,"active"))?(this.P(a),Md(b,U(this,"active"))):(this.show(a),J(b,U(this,"active")))))};
h.show=function(a){jl.B.show.call(this,a);var b=this.L(a),c=ia(a).toString();if(!Ya(b,"click-outside-persists")){if(this.b[c])return;var b=Q(document,"click",v(this.Ra,this,a)),d=Q(window,"blur",v(this.Ra,this,a));this.b[c]=[b,d]}a=Q(window,"resize",v(this.Mc,this,a,void 0));this.f[c]=a};
h.P=function(a){jl.B.P.call(this,a);a=ia(a).toString();var b=this.b[a];b&&(Ig(b),this.b[a]=null);if(b=this.f[a])Ig(b),delete this.f[a]};
...
h.Ya=function(a){if(ll!=a){ll&&(this.P(ll),ll=null);var b=v(this.show,this,a),c=parseInt(this.j(a,"delay-show"),10),b=x(b,-1<c?c:200);Wa(a,"card-timer",b.toString());ll=a;a.alt&&(Wa(a,"card-alt",a.alt),a.alt="");a.title&&(Wa(a,"card-title",a.title),a.title="")}};
h.$a=function(a){var b=parseInt(this.j(a,"card-timer"),10);Qa(b);this.L(a).isCardHidable=!0;b=parseInt(this.j(a,"delay-hide"),10);b=-1<b?b:200;x(v(this.$b,this,a),b);if(b=this.j(a,"card-alt"))a.alt=b;if(b=this.j(a,"card-title"))a.title=b};
...
h.dispose=function(){hk(this.b)&&this.dismiss("dispose");Ig(this.F);this.F.length=0;x(v(function(){this.D=null},this),0);
this.K=this.g=null;this.i.dispose();this.i=null;this.N=!0};
h.Sb=function(a){a.stopPropagation();sl(this)};
function sl(a){x(v(function(){this.g&&this.g.focus()},a),0)}
q("yt.ui.Dialog",ml,void 0);function vl(){rk.call(this,"overlay");this.i=this.f=this.g=this.b=null}
w(vl,rk);ba(vl);h=vl.prototype;h.register=function(){W(this,"click",this.Ca,"target");W(this,"click",this.vb,"close");wl(this)};
h.unregister=function(){vl.B.unregister.call(this);X(this,"click",this.Ca,"target");X(this,"click",this.vb,"close");this.i&&(gc(this.i),this.i=null);this.f&&(Ig(this.f),this.f=null)};
...
function yl(a){if(a.b){var b=a.g;a.b.dismiss("overlayhide");b&&a.Z(b,"overlay-hidden");a.g=null;a.f&&(Ig(a.f),a.f=null);a.b=null}}
...
function Al(){var a=vl.getInstance();if(a.g)a=O("yt-dialog-fg-content",a.g.overlayContentNode);else a:{if(a=Ef("yt-dialog-fg-content"))for(var b=0;b<a.length;b++){var c=P(a[b],"yt-dialog");if(hk(c)){a=a[b];break a}}a=null}return a}
...
function El(a,b){Ig(Cl);Cl.length=0;Bl[b]||(Bl[b]=Dl(a));vl.getInstance().show(Bl[b]);var c=Al();return new gf(function(a){Cl.push(Gg(c,function(){a()},"overlay-confirmation-unsubscribe-button"))})}
;function Fl(a,b){var c=document.location.protocol+"//"+document.domain+"/post_login";b&&(c=Ad(c,"mode",b));c=Ad("/signin?context=popup","next",c);c=Ad(c,"feature","sub_button");if(c=window.open(c,"loginPopup","width=375,height=440,resizable=yes,scrollbars=yes",!0)){var d=ec("LOGGED_IN",function(b){gc(Oa("LOGGED_IN_PUBSUB_KEY",void 0));gb("LOGGED_IN",!0);a(b)});
gb("LOGGED_IN_PUBSUB_KEY",d);c.moveTo((screen.width-375)/2,(screen.height-440)/2)}}
q("yt.pubsub.publish",E,void 0);function Gl(){var a=B("PLAYER_CONFIG");return a&&a.args&&void 0!==a.args.authuser?!0:!(!B("SESSION_INDEX")&&!B("LOGGED_IN"))}
...
h.oa=function(a){if(!(this.b&&1E3>pa()-this.b)){var b=parseInt(this.j(a,"tooltip-hide-timer"),10);b&&(Za(a,"tooltip-hide-timer"),Qa(b));var b=v(function(){Il(this,a);Za(a,"tooltip-show-timer")},this),c=parseInt(this.j(a,"tooltip-show-delay"),10)||0,b=x(b,c);
Wa(a,"tooltip-show-timer",b.toString());a.title&&(uk(a,Jl(this,a)),a.title="");b=ia(a).toString();this.f[b]=a}};
h.X=function(a){var b=parseInt(this.j(a,"tooltip-show-timer"),10);b&&(Qa(b),Za(a,"tooltip-show-timer"));b=v(function(){if(a){var b=N(Kl(this,a));b&&(Ll(b),Of(b),Za(a,"content-id"));b=N(Kl(this,a,"arialabel"));Of(b)}Za(a,"tooltip-hide-timer")},this);
b=x(b,50);Wa(a,"tooltip-hide-timer",b.toString());if(b=this.j(a,"tooltip-text"))a.title=b;b=ia(a).toString();delete this.f[b]};
...
function Ml(a,b,c){uk(b,c);a=a.j(b,"content-id");(a=N(a))&&Uf(a,c)}
function Jl(a,b){return a.j(b,"tooltip-text")||b.title}
function Il(a,b){if(b){var c=Jl(a,b);if(c){var d=N(Kl(a,b));if(!d){d=document.createElement("div");d.id=Kl(a,b);d.className=U(a,"tip");var e=document.createElement("div");e.className=U(a,"tip-body");var f=document.createElement("div");f.className=U(a,"tip-arrow");var g=document.createElement("div");g.setAttribute("aria-hidden","true");g.className=U(a,"tip-content");var k=Nl(a,b),l=Kl(a,b,"content");g.id=l;Wa(b,"content-id",l);e.appendChild(g);k&&d.appendChild(k);d.appendChild(e);d.appendChild(f);
var m=bg(b),l=Kl(a,b,"arialabel"),f=document.createElement("div");J(f,U(a,"arialabel"));f.id=l;m=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+m:m+" "+c;Uf(f,m);b.setAttribute("aria-labelledby",l);l=Rh()||document.body;l.appendChild(f);l.appendChild(d);Ml(a,b,c);(c=parseInt(a.j(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",J(g,U(a,"normal-wrap")));g=I(b,U(a,"reverse"));Ol(a,b,d,e,k,g)||Ol(a,b,d,e,k,!g);var r=U(a,"tip-visible");
x(function(){J(d,r)},0)}}}}
function Ol(a,b,c,d,e,f){Od(c,U(a,"tip-reverse"),f);var g=0;f&&(g=1);var k=Hh(b);f=new K((k.width-10)/2,f?k.height:0);var l=Eh(b);mk(new K(l.l+f.l,l.o+f.o),c,g);f=If(window);var m;1==c.nodeType?m=Fh(c):(c=c.changedTouches?c.changedTouches[0]:c,m=new K(c.clientX,c.clientY));c=Hh(d);var r=Math.floor(c.width/2),g=!!(f.height<m.o+k.height),k=!!(m.o<k.height),l=!!(m.l<r);f=!!(f.width<m.l+r);m=(c.width+3)/-2- -5;a=a.j(b,"force-tooltip-direction");if("left"==a||l)m=-5;else if("right"==a||f)m=20-c.width-
3;a=Math.floor(m)+"px";d.style.left=a;e&&(e.style.left=a,e.style.height=c.height+"px",e.style.width=c.width+"px");return!(g||k)}
function Kl(a,b,c){a=U(a)+lg(b);c&&(a+="-"+c);return a}
...
function Ll(a){var b=N("yt-uix-tooltip-shared-mask"),c=b&&eg(b,function(b){return b==a},!1,2);
...
h.ob=function(a,b,c){b?(Wa(a,Rl.Ha,"true"),c&&Wa(a,Rl.Ja,c),this.j(a,Rl.Fb)&&(b=new Ij,Wa(a,Rl.Ia,(b.getTime()/1E3).toString()))):(Za(a,Rl.Ha),Za(a,Rl.Ia),Za(a,Rl.Ja));Vl(this,a)};
...
function Vl(a,b){var c=a.j(b,Rl.Gb),d=!!a.j(b,"is-subscribed"),c="-"+c,e=Ql.zb+c;Od(b,Ql.yb+c,!d);Od(b,e,d);a.j(b,Rl.Db)&&!a.j(b,Rl.Cb)&&(c=U(Hl.getInstance()),Od(b,c,!d),b.title=d?"":a.j(b,Rl.Eb));d?x(function(){J(b,Ql.Ga)},1E3):Md(b,Ql.Ga)}
h.Qb=function(a){var b=!!this.j(a,"ypc-item-type"),c=!!this.j(a,"ypc-item-id");!this.j(a,"ypc-enabled")&&b&&c&&(J(a,"ypc-enabled"),Wa(a,Rl.Ib,"true"))};
h.Ob=function(a){this.j(a,"ypc-enabled")&&(Md(a,"ypc-enabled"),Za(a,"ypc-enabled"))};
function Wl(a,b){return ib(Ef(U(a)),function(a){return b==this.j(a,"channel-external-id")},a)}
...
function Ul(a,b){var c=v(function(a){a.discoverable_subscriptions&&gb("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.Fa(b)},a);
Fl(c,"subscribe")}
...
;var Xl=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};q("yt.uix.widgets_",Xl,void 0);function Yl(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function bm(a){var b=a.video_id||a.videoId;if(u(b)){var c=zg()||{},d=zg()||{};p(void 0)?d[b]=void 0:delete d[b];var e=pa()+3E5,f=Bg;if(f&&window.JSON){u(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
...
function gm(a){Gl()?(T(Rj,new Mj(a.externalChannelId,a.fc?{itemType:"U",itemId:a.externalChannelId}:null)),a=zd({event:"subscribe",source:a.source}),Zh("/gen_204?"+a,void 0)):hm(a)}
function hm(a){Fl(function(b){b.subscription_ajax&&gm(a)},null)}
function im(a){a=em(a);T(Wj,new Oj(a.externalChannelId,a.subscriptionId,null));a=zd({event:"unsubscribe",source:a.source});Zh("/gen_204?"+a,void 0)}
function jm(a){cm&&cm.channelSubscribed(a.b,a.subscriptionId)}
function km(a){cm&&cm.channelUnsubscribed(a.b)}
;function lm(a){y.call(this);this.f=a;this.f.subscribe("command",this.kb,this);this.g={};this.i=!1}
w(lm,y);h=lm.prototype;h.start=function(){this.i||this.C()||(this.i=!0,mm(this.f,"RECEIVING"))};
...
h.G=function(){var a=this.f;a.C()||Yb(a.b,"command",this.kb,this);this.f=null;for(var b in this.g)nm(this,b);lm.B.G.call(this)};function qm(a,b,c){th.call(this);this.f=a;this.g=b;this.w=c}
w(qm,th);function mm(a,b,c){if(!a.C()){var d=a.f;d.C()||a.g!=d.b||(a={id:a.w,command:b},c&&(a.data=c),d.b.postMessage(Oc(a),d.g))}}
qm.prototype.G=function(){this.g=this.f=null;qm.B.G.call(this)};new D;function rm(){var a=this.f=new Qh(!!B("WIDGET_ID_ENFORCE")),b=v(this.Dc,this);a.w=b;a.A=null;this.f.channel="widget";if(a=B("WIDGET_ID"))this.f.b=a;this.i=[];this.A=!1;this.w={}}
...
h.dispose=function(){this.f=null};function um(a,b,c){y.call(this);this.b=a;this.g=c;this.i=Q(window,"message",v(this.w,this));this.f=new qm(this,a,b);ab(this,na(bb,this.f))}
w(um,y);um.prototype.w=function(a){var b;if(b=!this.C())if(b=a.origin==this.g)a:{b=this.b;do{var c;b:{c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,u(a))){try{a=Mc(a)}catch(d){return}a.command&&(b=this.f,b.C()||b.i("command",a.command,a.data))}};
um.prototype.G=function(){Ig(this.i);this.b=null;um.B.G.call(this)};function vm(a,b){lm.call(this,b);this.b=a;this.start()}
...
var Bm=ym,Cm=zm;(function(){var a;return He?(a=/Windows NT ([0-9.]+)/,(a=a.exec(db))?a[1]:"0"):Ge?(a=/10[_.][0-9_.]+/,(a=a.exec(db))?a[0].replace(/_/g,"."):"10"):Ie?(a=/Android\s+([^\);]+)(\)|;)/,(a=a.exec(db))?a[1]:""):Je||Ke||Le?(a=/(?:iPhone|CPU)\s+OS\s+(\S+)/,(a=a.exec(db))?a[1].replace(/_/g,"."):""):""})();function Dm(a){return(a=a.exec(db))?a[1]:""}
(function(){if(Ze)return Dm(/Firefox\/([0-9.]+)/);if(L||Ce||Be)return Re;if(cf)return Dm(/Chrome\/([0-9.]+)/);if(df&&!(od()||z("iPad")||z("iPod")))return Dm(/Version\/([0-9.]+)/);if($e||af){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(db);if(a)return a[1]+"."+a[2]}else if(bf)return(a=Dm(/Android\s+([0-9.]+)/))?a:Dm(/Version\/([0-9.]+)/);return""})();(function(){var a=!1;try{var b=Object.defineProperty({},"passive",{get:function(){a=!0}});
n.addEventListener("test",null,b)}catch(c){}return a})();var Em=(new Date).getTime();function Fm(a){sa.call(this,a.message||a.description||a.name);this.b=a instanceof pf}
w(Fm,sa);Fm.prototype.name="BiscottiError";function Gm(a,b){this.f=a;this.b=b}
Gm.prototype.then=function(a,b,c){try{if(p(this.f))return a?mf(a.call(c,this.f)):mf(this.f);if(p(this.b)){if(!b)return nf(this.b);var d=b.call(c,this.b);return!p(d)&&this.b.b?nf(this.b):mf(d)}throw Error("Invalid Result_ state");}catch(e){return nf(e)}};
...
function Km(a,b){x(function(){var a=v(Lm,n,b),a=ai().then(Im,a);of(a,null,aa,void 0)},a)}
function Jm(a){q("yt.www.ads.biscotti.lastId_",a,void 0)}
;function Mm(){}
function Nm(){try{var a;try{var b=t("yt.www.ads.biscotti.getId_"),c;if(b)c=b();else{if(!Hm){var d=v(Lm,n,2);Hm=ai().then(Im,d)}c=Hm}a=c}catch(e){a=nf(e)}a.then(Om,Mm);x(Nm,18E5)}catch(e){Ra(e)}}
...
Z.navigator&&Z.navigator.plugins&&(b.u_nplug=Z.navigator.plugins.length);Z.navigator&&Z.navigator.mimeTypes&&(b.u_nmime=Z.navigator.mimeTypes.length);b.bid=a;b.ca_type=Bm?"flash":"image";if(Bd("enable_server_side_search_pyv")||Bd("enable_server_side_mweb_search_pyv")){var d;a=window;try{d=a.screenX;var e=a.screenY}catch(r){}try{var f=a.outerWidth,g=a.outerHeight}catch(r){}try{var k=a.innerWidth,l=a.innerHeight}catch(r){}d=[a.screenLeft,a.screenTop,d,e,a.screen?a.screen.availWidth:void 0,a.screen?
a.screen.availTop:void 0,f,g,k,l];var m;e=window.top||Z;try{m=e.document&&!e.document.body?new Uc(-1,-1):If(e||window).round()}catch(r){m=new Uc(-12245933,-12245933)}e=0;window.SVGElement&&document.createElementNS&&(e|=1);oa(b,{bc:e,bih:m.height,biw:m.width,brdim:d.join(),vis:{visible:1,hidden:2,prerender:3,preview:4}[xm.webkitVisibilityState||xm.mozVisibilityState||xm.visibilityState||""]||0,wgl:!!Z.WebGLRenderingContext})}Og("//www.youtube.com/ad_data_204",{ac:!1,J:b})}
;function Pm(){this.b=B("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Xc.get(""+this.b,void 0)){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Qm[d]=c.toString())}}}
ba(Pm);var Qm=t("yt.prefs.UserPrefs.prefs_")||{};q("yt.prefs.UserPrefs.prefs_",Qm,void 0);function Rm(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
...
function kn(a,b,c,d){var e=new Kj(a);T(Sj,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=B("PLAYBACK_ID"))&&(c.plid=d);(d=B("EVENT_ID"))&&(c.ei=d);b&&xn(b,c);Pg("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Da:f,J:c,O:function(b,c){var d=c.response;T(Uj,new Nj(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&E("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Um(d.actions)},
Ba:function(){T(Tj,e)}})}
function mn(a,b,c,d,e){var f=new Kj(a);T(Xj,f);var g={};d&&(g.eurl=d);e&&(g.source=e);d={};d.c=a;d.s=b;(a=B("PLAYBACK_ID"))&&(d.plid=a);(a=B("EVENT_ID"))&&(d.ei=a);c&&xn(c,d);Pg("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Da:g,J:d,O:function(a,b){var c=b.response;T(Zj,f);c.actions&&Um(c.actions)},
Ba:function(){T(Yj,f)}})}
function sn(a,b,c){if(a){var d={};d.channel_id=a;switch(b){case "receive-all-updates":d.receive_all_updates=!0;break;case "receive-no-updates":d.receive_no_updates=!0;d.receive_post_updates=!1;break;case "receive-highlight-updates":d.receive_all_updates=!1;d.receive_no_updates=!1;break;default:return}null===c||d.receive_no_updates||(d.receive_post_updates=c);var e=new Lj(a,b,c);Pg("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",J:d,onError:function(){T(fk,e)},
O:function(){T(ek,e)}})}}
...
Pg("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",J:c,O:function(c,f){d();var e=f.response,k=e.id;if(da(k)&&k.length==b.length){var l=e.channel_info_map;C(k,function(a,c){var d=b[c];T(Uj,new Nj(d,a,l[d]))});
...
Pg("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",J:c,O:function(){d();wn(b,Zj);a.length&&qn(a)},
onError:function(){d()}})}}
function wn(a,b){C(a,function(a){T(b,new Kj(a))})}
function xn(a,b){var c=Sd(a);oa(b,c)}
;var yn=null,zn=null,An=null,Bn={};function Cn(a){ah(a.payload_name,a.payload,Bd("enable_youtubei_innertube")?Xg:hg,void 0)}
function Dn(a){var b=a.id;a=a.ve_type;var c=fd++;a=new ed(void 0,a,c);Bn[b]=a;b=hh();c=gh();b&&c&&bh(b,c,a)}
function En(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(gb("client-screen-nonce",b),gb("ROOT_VE_TYPE",a),a=gh()))for(var c in Bn)bh(b,a,Bn[c])}
...
;q("yt.setConfig",gb,void 0);q("yt.setMsg",function(a){Ta(Na,arguments)},void 0);
q("yt.logging.errors.log",function(a,b,c,d,e){c={name:c||B("INNERTUBE_CONTEXT_CLIENT_NAME",1),version:d||B("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e||!1;if(a&&e&&!(5<=Wg)){e=a.stacktrace;d=a.columnNumber;var f=t("window.location.href");if(u(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:f,stack:"Not available"};else{var g,k,l=!1;try{g=a.lineNumber||a.line||"Not available"}catch(M){g="Not available",l=!0}try{k=a.fileName||a.filename||a.sourceURL||
n.$googDebugFname||f}catch(M){k="Not available",l=!0}a=!l&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:g,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;g=a.lineNumber.toString();isNaN(g)||isNaN(d)||(g=g+":"+d);if(!(Vg[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){b={Da:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:g,level:b||"ERROR"},J:{url:B("PAGE_NAME",
window.location.href),file:a.fileName},method:"POST"};e&&(b.J.stack=e);for(var m in c)b.J["client."+m]=c[m];if(m=Oa("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var r in m)b.J[r]=m[r];Pg("/error_204",b);Vg[a.message]=!0;Wg++}}},void 0);
q("writeEmbed",function(){var a=Oa("PLAYER_CONFIG",void 0);"1"!=a.privembed&&Nm();"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=B("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);B("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&bm(a.args);yn=a=sj("player",a);a.addEventListener("onScreenChanged",En);a.addEventListener("onLogClientVeCreated",Dn);a.addEventListener("onLogServerVeCreated",Fn);a.addEventListener("onLogToGel",
Cn);a.addEventListener("onLogVeClicked",Gn);a.addEventListener("onLogVesShown",Hn);a.addEventListener("onReady",In);b=B("POST_MESSAGE_ID","player");B("ENABLE_JS_API")?An=new wm(a):B("ENABLE_POST_API")&&u(b)&&u(c)&&(zn=new um(window.parent,b,c),An=new vm(a,zn.f));B("BG_P")&&(B("BG_I")||B("BG_IU"))&&tc();yc();cm=a;cm.addEventListener("SUBSCRIBE",fm);cm.addEventListener("UNSUBSCRIBE",im);dm.push(Gi(Uj,jm),Gi(Zj,km))},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){Zh(a+"mac_204?action_fcts=1");return!0},void 0);
var Jn=Pa(function(){Oi("ol");fn=!0;hn.push(Gi(Rj,jn),Gi(Wj,ln));fn||hn.push(Gi(Vj,jn),Gi(ak,ln),Gi(Pj,nn),Gi(Qj,pn),Gi(dk,rn),Gi(bn,tn),Gi(dn,vn),Gi(an,un));var a=Pm.getInstance(),b=1<window.devicePixelRatio;if(!!((Tm("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=Tm(c)||0,d=b?d|67108864:d&-67108865;0==d?delete Qm[c]:(b=d.toString(16),Qm[c]=b.toString());var a=a.b,c=[],e;for(e in Qm)c.push(e+"="+escape(Qm[e]));Xc.set(""+a,c.join("&"),63072E3,"/","youtube.com")}}),
Kn=Pa(function(){var a=yn;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();B("PL_ATT")&&(sc=null);for(var a=0,b=wc.length;a<b;a++){var c=wc[a];if(!isNaN(c)){var d=t("yt.scheduler.instance.cancelJob");d?d(c):Qa(c)}}wc.length=0;a=oc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))jc(a),b.parentNode.removeChild(b);xc=!1;gb("DCLKSTAT",0);gc(gn);gn.length=0;Hi(hn);hn.length=0;fn=!1;cm&&(cm.removeEventListener("SUBSCRIBE",gm),cm.removeEventListener("UNSUBSCRIBE",im));cm=null;Hi(dm);dm.length=0;
cb(An,zn);if(a=yn)a.removeEventListener("onScreenChanged",En),a.removeEventListener("onLogClientVeCreated",Dn),a.removeEventListener("onLogServerVeCreated",Fn),a.removeEventListener("onLogToGel",Cn),a.removeEventListener("onLogVeClicked",Gn),a.removeEventListener("onLogVesShown",Hn),a.removeEventListener("onReady",In),a.destroy();Bn={}});
