			...
			b91a0e3e9d_partners.setAttribute('src', '//twodrive.su/code/partners.php?id=14853360452988702025');
			...
			document.getElementById('b91a0e3e9d').style.margin = "0 auto";
									...
									b91a0e3e9d_banner_swf.setAttribute('src', '//twodrive.su/code/swf_banner.php?img_adv=&img2_adv=WlUNCARAagRWBQJa.txt&img_sep=txt&dim_width='+b91a0e3e9d_dim_width+'&dim_height='+b91a0e3e9d_dim_height+'&data=&b_click=R0dcZlLnN1L2NsaWNfU2eaHR0cDovL3R3b2RyaXcH7wrcy9iYS9BQUJTT1ZVQ0FBZGYucGc4f9Hhw'); 
