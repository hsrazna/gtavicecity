...
(lib.Символ139 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF0000","#1EFF00"],[0,1],0,-124.1,0,124.1).s().p("AhpTuMAAAgnbIDTAAMAAAAnbg");
	this.shape.setTransform(13,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ139, new cjs.Rectangle(2.3,-126.2,21.3,252.4), null);
...
(lib.Символ83 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-370.9,-159,1.091,1.148,0,-178.3,1.7);

	this.instance_1 = new lib.fon();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-395.4,660.5,1.094,1.43,0,-178.3,1.7);

	this.instance_2 = new lib.fon();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-370.8,-164.6,1.091,1.091,1.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ83, new cjs.Rectangle(-395.4,-540.1,788.8,1223.5), null);
...
p.nominalBounds = new cjs.Rectangle(-55.1,115.3,78.7,19.3);
...
(lib.Символ137 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-13.1,-5.9,0.718,0.718);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-13.1,-5.2,0.718,0.718);
	this.instance_1.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_1.cache(-9,-53,19,106);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ137, new cjs.Rectangle(-20.4,-43.8,19,80), null);
...
(lib.Символ135 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-187.2,-5.1,0.755,1,0,0,180);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-174.2,-5.8);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-174.2,-5.1,1,1,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ135, new cjs.Rectangle(-236.3,-133.1,117.2,575.2), null);
...
(lib.Символ89 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(560.7,-31);

	this.instance_1 = new lib.Символ88();
	this.instance_1.parent = this;
	this.instance_1.setTransform(436.3,-35.4);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(436.3,-33.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ89, new cjs.Rectangle(334.5,-52.9,245.4,39.5), null);
...
(lib.Символ65 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-55.2,31.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-211.5},39,cjs.Ease.get(1)).to({x:-55.2},40,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-84.2,2.2,58.1,58.1);
...
p.nominalBounds = new cjs.Rectangle(-84.6,2,58.1,58.1);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.bulki).to({regX:-76.4,regY:0.3,rotation:2.5,x:-100.7},14,cjs.Ease.get(-1)).to({regY:0.1,rotation:0,x:-100.6},15,cjs.Ease.get(1)).to({regY:0.2,rotation:2.3,x:-100.7,y:5},15,cjs.Ease.get(-1)).to({regX:-76.3,rotation:5,x:-100.6,y:4.9},15,cjs.Ease.get(1)).wait(1).to({regX:-76.4,regY:0.3,rotation:2.5,x:-100.7},14,cjs.Ease.get(-1)).to({regY:0.1,rotation:0,x:-100.6},15,cjs.Ease.get(1)).to({regY:0.2,rotation:2.3,x:-100.7,y:5},15,cjs.Ease.get(-1)).to({regX:-76.3,rotation:5,x:-100.6,y:4.9},15,cjs.Ease.get(1)).wait(2).to({regX:-1.5,regY:-60,rotation:3.1,x:-37.3,y:-40.7},0).wait(1).to({rotation:2,x:-38.1,y:-41.9},0).wait(1).to({rotation:1.3,x:-38.7,y:-42.6},0).wait(1).to({rotation:0.9,x:-39,y:-43.1},0).wait(1).to({rotation:0.6,x:-39.3,y:-43.5},0).wait(1).to({rotation:0.4,x:-39.5,y:-43.7},0).wait(1).to({rotation:0.2,x:-39.6,y:-43.9},0).wait(1).to({regX:-76.4,regY:0.1,rotation:0,x:-100.6,y:4.9},0).wait(1).to({regX:-1.5,regY:-60,rotation:1.9,x:-38.2,y:-41.9},0).wait(1).to({rotation:3,x:-37.3,y:-40.7},0).wait(1).to({rotation:3.6,x:-36.8,y:-40.1},0).wait(1).to({rotation:4.1,x:-36.4,y:-39.5},0).wait(1).to({rotation:4.4,x:-36.2,y:-39.2},0).wait(1).to({rotation:4.6,x:-36,y:-39},0).wait(1).to({rotation:4.8,x:-35.9,y:-38.7},0).wait(1).to({regX:-76.3,regY:0.2,rotation:5,x:-100.6,y:4.9},0).wait(1));
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],0,-99.4,0,99.5).s().p("A6LS/MAAAgl9MA0XAAAMAAAAl9g");
	this.shape.setTransform(2.7,-180.1);
...
p.nominalBounds = new cjs.Rectangle(-378.4,-517.2,788.8,1223.5);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-197.3,-217.3,0.515,0.515,0,0,0,-0.3,-0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:-0.3,y:-158.2},4).to({regY:-0.2,y:-165.2},2).wait(1).to({regY:-0.3,y:-158.2},2).to({regY:-0.2,y:-217.3},4).wait(1));

	// Слой 5
	this.instance_1 = new lib.Символ67();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-188.3,-162.5,0.515,0.515,0,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:-0.2,y:-158.4},2).to({regY:-0.1,y:-215.7},4).wait(1).to({regY:-0.2,y:-158.4},4).to({regY:-0.1,y:-162.5},2).wait(1));

	// Слой 6
	this.instance_2 = new lib.Символ89();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-441.9,109.2,0.547,0.547,0,0,0,-0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:454.7,regY:-37.5,x:-193.3,y:102.4},0).wait(1).to({y:119.2},0).wait(1).to({y:128.7},0).wait(1).to({y:133.8},0).wait(1).to({y:138.3},0).wait(1).to({regX:-0.2,regY:0.1,x:-441.9,y:165.7},0).wait(2).to({regX:454.7,regY:-37.5,x:-193.3,y:135.7},0).wait(1).to({y:126.3},0).wait(1).to({y:116.9},0).wait(1).to({y:107.5},0).wait(1).to({y:98.1},0).wait(1).to({regX:-0.2,regY:0.2,x:-441.9,y:109.2},0).wait(1));

	// Слой 9
	this.instance_3 = new lib.Символ135();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-250.9,40.5,0.523,0.523,0,0,0,0,-0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:-0.2,x:-178.2},6,cjs.Ease.get(1)).wait(1).to({regX:0,x:-250.9},6,cjs.Ease.get(1)).wait(1));

	// Слой 4
	this.instance_4 = new lib.Символ57();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-90.2,-17.7,0.81,0.81);
	...
	this.instance_5.setTransform(-103.8,192.3,0.615,0.615,0,0,0,0.1,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:0.1,y:67.4},6,cjs.Ease.get(1)).wait(1).to({y:57.9},0).to({regY:0,y:192.3},6).wait(1));

	// Слой 1
	this.devochka = new lib.Символ1();
	this.devochka.parent = this;
	this.devochka.setTransform(-195,-50.7,0.623,0.623,0,0,0,0,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.devochka).to({regX:-0.1,scaleX:0.66,scaleY:0.66,y:-7.9},6,cjs.Ease.get(1)).wait(1).to({regX:0,scaleX:0.62,scaleY:0.62,y:-50.7},6).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-430.6,-372.7,491.3,761.9);


// stage content:
(lib.muha240x400 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.prizel.setTransform(-150.9,-73.8,1.358,1.358);
	...
	this.muhavniz.setTransform(117.3,58.5,1.149,1.149,0,0,0,0.1,0.1);
	...
	this.bulkibtn.setTransform(47.1,228.4,0.839,0.899,0,0,0,0.1,0.1);
	...
	this.main.setTransform(389.6,246,1.358,1.358);

	this.timeline.addTween(cjs.Tween.get(this.main).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-75.2,-60.2,667,1034.6);
// library properties:
lib.properties = {
	width: 240,
	height: 400,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fon.jpg?1479981375581", id:"fon"},
		{src:"images/mish.png?1479981375581", id:"mish"},
		{src:"images/muha2_01.png?1479981375581", id:"muha2_01"},
		{src:"images/muha2_03.png?1479981375581", id:"muha2_03"},
		{src:"images/muha2_04.png?1479981375581", id:"muha2_04"},
		{src:"images/muha_01.png?1479981375581", id:"muha_01"},
		{src:"images/muha_04.png?1479981375581", id:"muha_04"},
		{src:"images/muha_07.png?1479981375581", id:"muha_07"},
		{src:"images/muha_12.png?1479981375581", id:"muha_12"},
		{src:"images/muha_15.png?1479981375581", id:"muha_15"},
		{src:"images/muha_19.png?1479981375581", id:"muha_19"},
		{src:"images/muha_22.png?1479981375581", id:"muha_22"},
		{src:"images/muhoboyka.png?1479981375581", id:"muhoboyka"},
		{src:"images/rot.png?1479981375581", id:"rot"}
	],
	preloads: []
};
